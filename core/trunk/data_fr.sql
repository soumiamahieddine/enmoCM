...
INSERT INTO status (id, label_status, is_system, img_filename, maarch_module, can_be_searched) VALUES ('MAQUAL', 'Email à qualifier', 'N', '', 'apps', 'Y');
...
INSERT INTO baskets (coll_id, basket_id, basket_name, basket_desc, basket_clause, is_generic, enabled) VALUES ('letterbox_coll', 'MyBasket', 'Mes courriers à traiter', 'Mes courriers à traiter', '(status =''NEW'' or status =''COU'') and dest_user = @user', 'N', 'Y');
