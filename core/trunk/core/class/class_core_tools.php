...
class core_tools extends functions
{
    ...
    */
    public function build_quicklaunch($quicklaunch)
    {
        ...
        echo '<span>';
        echo '<span style="width:30px;height:30px;display:inline-block;text-align:center;"><i class="fa fa-user fa-2x mCsoDarkOrange"></i></span>';
        ...
        echo '<span>';
        echo '<span style="width:30px;height:30px;display:inline-block;text-align:center;"><i class="fa fa-power-off fa-2x mCsoDarkOrange"></i></span>';
