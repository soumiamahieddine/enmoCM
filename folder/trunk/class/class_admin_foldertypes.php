                ...
                <form name="formfoldertype" id="formfoldertype" method="post" action="<?php  if($mode == "up") { echo $_SESSION['config']['businessappurl']."index.php?display=true&module=folder&page=foldertype_up_db"; } elseif($mode == "add") { echo $_SESSION['config']['businessappurl']."index.php?display=true&module=folder&page=foldertype_add_db"; } ?>" class="forms">
                    ...
                    if($mode == "up")
                    {
                        ...
                        <p>
                            ...
                            <input name="foldertypeId" id="foldertypeId" type="text" value="<?php  echo $func->show_str($_SESSION['m_admin']['foldertype']['foldertypeId']); ?>" <?php  if($mode == "up") { echo 'readonly="readonly" class="readonly"';} ?> />
                    ...
                    if($mode == "up")
                    {
                        if($total_doc > 0)
                        {
                            ...
                            <p>
                                ...
                                <input name="collection_show" id="collection_show" type="text" value="<?php  echo $func->show_str($sec->retrieve_coll_label_from_coll_id($_SESSION['m_admin']['foldertype']['COLL_ID'])); ?>" readonly="readonly" class="readonly" />
                    ...
                    <p>
                        ...
                        <input name="desc"  type="text" id="desc" value="<?php  echo $func->show_str($_SESSION['m_admin']['foldertype']['desc']); ?>" />
                    </p>
                    <p>
