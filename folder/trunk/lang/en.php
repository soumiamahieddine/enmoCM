...
if (!defined('_FOLDERHASNODOC'))
    define('_FOLDERHASNODOC','No document in this folder');
if (!defined('_OTHER_INFOS'))
    define('_OTHER_INFOS','Other information : folder history and missing documents');
if (!defined('_SEARCH_FOLDER'))
    define('_SEARCH_FOLDER','Search folder');
...
if (!defined('_FOLDERTYPE_LABEL'))
    define('_FOLDERTYPE_LABEL','Folder type label');
if (!defined('_INFOS_FOLDERS'))
    define('_INFOS_FOLDERS','Folder info');
if (!defined('_CHOOSE_FOLDER'))
    define('_CHOOSE_FOLDER', 'Select a folder');

//////////////create_folder.php
if (!defined('_CREATE_THE_FOLDER'))
    define('_CREATE_THE_FOLDER', 'Add the folder');
if (!defined('_NEW_EMPLOYEES_LIST'))
    define('_NEW_EMPLOYEES_LIST','New employee list');
if (!defined('_FOLDERS_LIST'))
    define('_FOLDERS_LIST', 'List of folders');
if (!defined('_FOLDERS'))
...
if (!defined('_FOLDER_CREATION'))
    define('_FOLDER_CREATION', 'Creating the folder');

///////////////delete_popup.php
if (!defined('_DEL_FOLDER_NUM'))
    define('_DEL_FOLDER_NUM', 'Deleting folder nb.');
...
if (!defined('_PLEASE_SELECT_FOLDER'))
    define('_PLEASE_SELECT_FOLDER', 'You must select a folder');
if (!defined('_FOLDER_HISTORY'))
    define('_FOLDER_HISTORY', 'Folder history');
...
if (!defined('_FOLDERTYPE_ADDITION'))
    define('_FOLDERTYPE_ADDITION', 'Add folder type');
if (!defined('_FOLDERTYPE_MODIFICATION'))
    define('_FOLDERTYPE_MODIFICATION', 'Modifying a folder type');
if (!defined('_FOLDERTYPES_LIST'))
    define('_FOLDERTYPES_LIST', 'list of folder types');
if (!defined('_TYPES'))
    define('_TYPES', 'type(s)');
if (!defined('_ALL_FOLDERTYPES'))
    define('_ALL_FOLDERTYPES', 'All types');
if (!defined('_FOLDERTYPE'))
    define('_FOLDERTYPE', 'Types of folder');
if (!defined('_FOLDERTYPE_MISSING'))
    define('_FOLDERTYPE_MISSING', 'This folder type does not exist');
...
if (!defined('_DELETE_FOLDER_NOTES1'))
    define('_DELETE_FOLDER_NOTES1', 'Deleting a folder cannot be undone, its constitutive documents will still be archived, but they will not be available for consultation.');
if (!defined('_REALLY_DELETE_FOLDER'))
    define('_REALLY_DELETE_FOLDER', 'Do you want to delete the folder ?');
if (!defined('_DELETE_FOLDER_NOTES2'))
    define('_DELETE_FOLDER_NOTES2','To definitely delete the folder, enter &quot;EFFACER&quot; (in capitals) in the field below.');
...
if (!defined('_FOLDER_INDEX_MODIF'))
    define('_FOLDER_INDEX_MODIF', 'Modify the indices of the folder');
if (!defined('_FOLDERS_OUT'))
    define('_FOLDERS_OUT', 'Archived folders');
if (!defined('_VIEW'))
    define('_VIEW', 'View');
...
if (!defined('_MANDATORY_DOCTYPES_COMP'))
    define('_MANDATORY_DOCTYPES_COMP', 'Mandatory doctype for a folder to be complete');
if (!defined('_FOLDER_ID'))
    define('_FOLDER_ID', 'Folder ID');
if (!defined('_INDEX_FOR_FOLDERTYPES'))
    define('_INDEX_FOR_FOLDERTYPES', 'Available indices for folder types');
if (!defined('_SELECTED_DOCTYPES'))
    define('_SELECTED_DOCTYPES', 'Selected folder types');
if (!defined('_SHOW_FOLDER'))
    define('_SHOW_FOLDER', 'Folder details sheet');
if (!defined('_FOLDERTYPE_UPDATE'))
    define('_FOLDERTYPE_UPDATE', 'Folder type modified');
if (!defined('_FOLDER_ATTACH'))
    define('_FOLDER_ATTACH', 'Attach to a folder');
if (!defined('_INCOMPATIBILITY_MARKET_PROJECT'))
    define('_INCOMPATIBILITY_MARKET_PROJECT', 'Selected folder and sub-folder are not compatible');
if (!defined('_FOLDER_VIEW_STAT'))
    define('_FOLDER_VIEW_STAT', 'Number of folder viewed');
if (!defined('_FOLDER_VIEW_STAT_DESC'))
    define('_FOLDER_VIEW_STAT_DESC', 'Number of folder viewed');
if (!defined('_FOLDER_HISTORY_STAT'))
    define('_FOLDER_HISTORY_STAT', 'Log for the folder');
if (!defined('_FOLDER_HISTORY_STAT_DESC'))
    define('_FOLDER_HISTORY_STAT_DESC', 'Log for the folder');
if (!defined('_VIEW_FOLDER'))
    define('_VIEW_FOLDER', 'View the folder');
...
if (!defined('_TITLE_STATS_NO_FOLDERS_VIEW'))
    define('_TITLE_STATS_NO_FOLDERS_VIEW','No folder has been viewed on given period');
if (!defined('_STATS_ERROR_CHOSE_USER'))
    define('_STATS_ERROR_CHOSE_USER','You must select an existing user.');
if (!defined('_NB_FOLDERS'))
    define('_NB_FOLDERS', 'Number of folder');
if (!defined('_NB_VIEWED_FOLDERS'))
    define('_NB_VIEWED_FOLDERS','Number of folders viewed');
...
if (!defined('_NO_STRUCTURE_ATTACHED2'))
    define('_NO_STRUCTURE_ATTACHED2', 'This type of folder is not attached to any folders');
if (!defined('_FOLDER_ADDED'))
    define('_FOLDER_ADDED', 'New folder created');
if (!defined('_FOLDER_DETAILLED_PROPERTIES'))
    define('_FOLDER_DETAILLED_PROPERTIES', 'Information on the folder');
if (!defined('_FOLDER_PROPERTIES'))
    define('_FOLDER_PROPERTIES', 'Properties of the folder');
...
if (!defined('_FOLDER_INDEX_UPDATED'))
    define('_FOLDER_INDEX_UPDATED', 'Folder&apos;s indices have been modified');
if (!defined('_ALL_DOCS_WILL_BE_DELETED'))
    define('_ALL_DOCS_WILL_BE_DELETED', 'All document for this folder have been deleted!');
if (!defined('_STRING'))
...
if (!defined('_DELETED_FROM_FOLDER'))
    define('_DELETED_FROM_FOLDER', ' deleted from the folder');
if (!defined('_CHOOSE_PARENT_FOLDER'))
    define('_CHOOSE_PARENT_FOLDER', 'Attach to an existing parent folder');
if (!defined('_FOLDER_PARENT'))
    define('_FOLDER_PARENT', 'Parent folder');
if (!defined('_FOLDER_PARENT_DESC'))
    define('_FOLDER_PARENT_DESC', 'You can create a sub-folder by attaching it to a folder of the same type. There are only two levels : folder and sub-folder.');
