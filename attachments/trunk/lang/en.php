...
if (!defined('_ATTACHMENTS_COMMENT'))
    define('_ATTACHMENTS_COMMENT', 'Manage attachments');
if (!defined('_ATTACH_ANSWER'))
    define('_ATTACH_ANSWER', 'Add an attachment');
if (!defined('_ATTACH'))
    define('_ATTACH', 'Add an attachment');
...
if (!defined('_ATTACH_DELETED'))
    define('_ATTACH_DELETED', 'Attachment deleted');
if (!defined('_ATTACHED_DOC'))
    define('_ATTACHED_DOC', 'Attachments');

if (!defined('_INDEX_ATTACHMENT'))
    define('_INDEX_ATTACHMENT', 'Add an attachment');
if (!defined('_INDEX_ATTACHMENT_DESC'))
    define('_INDEX_ATTACHMENT_DESC', 'Add an attachment');
if (!defined('_ATTACH_TO_DOC'))
    define('_ATTACH_TO_DOC', 'Add as answer to an existing document');
if (!defined('_ATTACH_TO_DOC_NUM'))
    define('_ATTACH_TO_DOC_NUM', 'Attach to document number');
...
if (!defined('_MANAGE_ATTACHMENTS'))
    define('_MANAGE_ATTACHMENTS', 'Manage attachments');
if (!defined('_GENERATE_OFFICE_ATTACHMENT'))
    define('_GENERATE_OFFICE_ATTACHMENT', 'Generate Office Attachment');
if (!defined('_GENERATE_HTML_ATTACHMENT'))
    define('_GENERATE_HTML_ATTACHMENT', 'Generate HTML Attachment');
