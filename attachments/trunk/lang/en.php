...
if (!defined("_GENERATE_OFFICE_ATTACHMENT"))
    define("_GENERATE_OFFICE_ATTACHMENT", "Generate OFFICE");
if (!defined("_GENERATE_HTML_ATTACHMENT"))
    define("_GENERATE_HTML_ATTACHMENT", "Generate HTML");
if (!defined("_ATTACH_FROM_HDD"))
    define("_ATTACH_FROM_HDD", "Add an attachment / response from your hard drive");
if (!defined("_GENERATE_ATTACHMENT_FROM"))
    define("_GENERATE_ATTACHMENT_FROM", "Generate an attachment / response from a format model");

if (!defined("_EDIT_ATTACHMENTS_FROM_DETAILS"))
    define("_EDIT_ATTACHMENTS_FROM_DETAILS", "Manage attachments from detailed card");
...
if (!defined("_RETRIEVE_BACK_UP"))
    define( "_RETRIEVE_BACK_UP", "The last document was recovered because it was not correctly enclosed");
