...
INSERT INTO actions (id, keyword, label_action, id_status, is_system, action_page, component, history, parameters) VALUES (100, '', 'Voir le document', '', 'N', 'view', '', 'N', '{}');
...
INSERT INTO configurations (id, privilege, value) VALUES (4, 'admin_document_editors', '{"java": [], "onlyoffice": {"ssl": false, "uri": "10.9.95.18", "port": "4242", "token": "", "authorizationHeader": "Authorization"}}');
...
INSERT INTO parameters (id, description, param_value_string, param_value_int, param_value_date) VALUES ('workflowEndBySignatory', 'Si activé (1), le dernier utilisateur du circuit de visa doit être Signataire (0 pour désactiver)', NULL, 0, NULL);
...
INSERT INTO users (id, user_id, password, firstname, lastname, phone, mail, initials, preferences, status, password_modification_date, mode, refresh_token, reset_token, failed_authentication, locked_until, authorized_api, external_id, feature_tour) VALUES (25, 'superadmin2', '$2y$10$G0QEibjUhXnQz1NUaJQF2ePNH1a9srLBP8EC4YMQDY3FWuGeW8nBS', 'Admin', 'SUPER', NULL, 'yourEmail@domain.com', NULL, '{"documentEdition": "java"}', 'OK', '2021-03-24 10:17:02.960885', 'root_invisible', '[]', NULL, 0, NULL, '[]', '{}', '[]');
...
SELECT pg_catalog.setval('public.users_baskets_preferences_id_seq', 238, true);
