...
VALUES (1, 'ar_derogation', 'pdf', 'bbain', NOW(), 'MAARCH/2019D/1', 1, 'FASTHD_MAN', 'tests#', 'ar_derogation.pdf', '0', 41682, 'FRZ', NULL, NULL, NULL, NULL, 1, 'response_project', 4, 'contact', NULL, true, NULL, '{"signatureBookId": 1}');
INSERT INTO res_attachments (res_id, title, format, typist, creation_date, identifier, relation, docserver_id, path, filename, fingerprint, filesize, status, validation_date, effective_date, work_batch, origin, res_id_master, attachment_type, recipient_id, recipient_type, modified_by, in_signature_book, signatory_user_serial_id, external_id)
VALUES (2, 'ar_sva', 'pdf', 'ccharles', NOW(), 'MAARCH/2019D/2', 1, 'FASTHD_MAN', 'tests#', 'ar_sva.pdf', '0', 44907, 'FRZ', NULL, NULL, NULL, NULL, 2, 'response_project', 4, 'contact', NULL, true, NULL, '{"signatureBookId": 2}');
INSERT INTO res_attachments (res_id, title, format, typist, creation_date, identifier, relation, docserver_id, path, filename, fingerprint, filesize, status, validation_date, effective_date, work_batch, origin, res_id_master, attachment_type, recipient_id, recipient_type, modified_by, in_signature_book, signatory_user_serial_id, external_id)
VALUES (3, 'ar_svr', 'pdf', 'rrenaud', NOW(), 'MAARCH/2019D/3', 1, 'FASTHD_MAN', 'tests#', 'ar_svr.pdf', '0', 44907, 'FRZ', NULL, NULL, NULL, NULL, 3, 'response_project', 4, 'contact', NULL, true, NULL, '{"signatureBookId": 3}');
INSERT INTO res_attachments (res_id, title, format, typist, creation_date, identifier, relation, docserver_id, path, filename, fingerprint, filesize, status, validation_date, effective_date, work_batch, origin, res_id_master, attachment_type, recipient_id, recipient_type, modified_by, in_signature_book, signatory_user_serial_id, external_id)
VALUES (4, 'invitation', 'pdf', 'bbain', '2019-03-20 17:54:00.954235', 'MAARCH/2019D/4', 1, 'FASTHD_MAN', 'tests#', 'invitation.pdf', '0', 47379, 'FRZ', NULL, NULL, NULL, NULL, 4, 'outgoing_mail', 4, 'contact', NULL, true, NULL, '{"signatureBookId": 4}');
INSERT INTO res_attachments (res_id, title, format, typist, creation_date, identifier, relation, docserver_id, path, filename, fingerprint, filesize, status, validation_date, effective_date, work_batch, origin, res_id_master, attachment_type, recipient_id, recipient_type, modified_by, in_signature_book, signatory_user_serial_id, external_id)
VALUES (5, 'rep_creche', 'pdf', 'ssaporta', NOW(), 'MAARCH/2019D/5', 1, 'FASTHD_MAN', 'tests#', 'rep_creche.pdf', '0', 44907, 'FRZ', NULL, NULL, NULL, NULL, 5, 'response_project', 4, 'contact', NULL, true, NULL, '{"signatureBookId": 5}');
INSERT INTO res_attachments (res_id, title, format, typist, creation_date, identifier, relation, docserver_id, path, filename, fingerprint, filesize, status, validation_date, effective_date, work_batch, origin, res_id_master, attachment_type, recipient_id, recipient_type, modified_by, in_signature_book, signatory_user_serial_id, external_id)
VALUES (6, 'rep_standard', 'pdf', 'ssaporta', NOW(), 'MAARCH/2019D/6', 1, 'FASTHD_MAN', 'tests#', 'rep_standard.pdf', '0', 44907, 'FRZ', NULL, NULL, NULL, NULL, 6, 'response_project', 4, 'contact', NULL, true, NULL, '{"signatureBookId": 6}');
-- to process documents nnataly
INSERT INTO res_attachments (res_id, title, format, typist, creation_date, identifier, relation, docserver_id, path, filename, fingerprint, filesize, status, validation_date, effective_date, work_batch, origin, res_id_master, attachment_type, recipient_id, recipient_type, modified_by, in_signature_book, signatory_user_serial_id)
VALUES (7, 'rep_standard', 'pdf', 'ccharles', NOW(), 'MAARCH/2019D/7', 1, 'FASTHD_MAN', 'tests#', 'rep_standard_demande_intervention.pdf', '0', 44907, 'A_TRA', NULL, NULL, NULL, NULL, 18, 'response_project', 4, 'contact', NULL, true, NULL);
-- to paraph documents ppetit
INSERT INTO res_attachments (res_id, title, format, typist, creation_date, identifier, relation, docserver_id, path, filename, fingerprint, filesize, status, validation_date, effective_date, work_batch, origin, res_id_master, attachment_type, recipient_id, recipient_type, modified_by, in_signature_book, signatory_user_serial_id)
VALUES (8, 'rep_standard', 'pdf', 'ccharles', NOW(), 'MAARCH/2019D/8', 1, 'FASTHD_MAN', 'tests#', 'rep_standard_demande_intervention.pdf', '0', 44907, 'A_TRA', NULL, NULL, NULL, NULL, 19, 'response_project', 4, 'contact', NULL, true, NULL);
