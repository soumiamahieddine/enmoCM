...
INSERT INTO parameters (id, description, param_value_int) VALUES ('keepDestForRedirection', 'If actived (1), put recipient in copy for diffusion list when redirecting', 1);
...
INSERT INTO actions (id, keyword, label_action, id_status, is_system, enabled, action_page, history, origin, create_id, category_id, component) VALUES (501, '', 'Acknowledge archiving', 'ACK_SEDA', 'N', 'Y', 'ack_seda', 'Y', 'apps', 'N', NULL, NULL);
INSERT INTO actions (id, keyword, label_action, id_status, is_system, enabled, action_page, history, origin, create_id, category_id, component) VALUES (502, '', 'Send archiving acknowledge', 'REPLY_SEDA', 'N', 'Y', 'reply_seda', 'Y', 'apps', 'N', NULL, NULL);
