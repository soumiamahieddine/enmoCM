...
if (!defined('_ADMIN_LIFE_CYCLE_DESC'))
    define('_ADMIN_LIFE_CYCLE_DESC', 'D&eacute;finition des politiques d&rsquo;archivage, cycles et &eacute;tapes jusqu&rsquo;au sort final');
...
if (!defined('_MANAGE_LC_CYCLE_STEPS'))
    define('_MANAGE_LC_CYCLE_STEPS', 'G&eacute;rer les &eacute;tapes de cycle de vie');
if (!defined('_MANAGE_LC_POLICIES'))
    define('_MANAGE_LC_POLICIES', 'G&eacute;rer les politiques d&rsquo;archivage ');
...
if (!defined('_CYCLE_STEP_DESC'))
    define('_CYCLE_STEP_DESC','Description de l&rsquo;&eacute;tape de cycle de vie');
...
if (!defined('_LC_CYCLE_STEP_ADDITION'))
    define('_LC_CYCLE_STEP_ADDITION','Ajouter une &eacute;tape de cycle de vie');
...
if (!defined('_LC_CYCLE_STEP_MODIFICATION'))
    define('_LC_CYCLE_STEP_MODIFICATION','Modification d&rsquo; une &eacute;tape de cycle de vie');
...
if (!defined('_LC_POLICY_MODIFICATION'))
    define('_LC_POLICY_MODIFICATION','Modification de la politique d&rsquo;archivage');
if (!defined('_MISSING_A_CYCLE_STEP'))
    define('_MISSING_A_CYCLE_STEP', 'Vous devez ajouter au moins une &eacute;tape de cycle de vie pour compl&eacute;ter votre param&eacute;trage');
if (!defined('_MISSING_A_CYCLE_AND_A_CYCLE_STEP'))
    define('_MISSING_A_CYCLE_AND_A_CYCLE_STEP', 'Vous devez ajouter au moins un cycle de vie et une &eacute;tape pour compl&eacute;ter votre param&eacute;trage');
...
if (!defined('_VIEW_GENERAL_PARAMETERS_OF_THE_POLICY'))
    define('_VIEW_GENERAL_PARAMETERS_OF_THE_POLICY', 'Voir le param&eacute;trage global de la politique de cycle de vie');
