...
if (!defined('_MANAGE_LC_CYCLE_STEPS'))  define('_MANAGE_LC_CYCLE_STEPS', 'G&eacute;rer les &eacute;tapes de cycle de vie');
...
if (!defined('_POLICY_ID'))  define('_POLICY_ID', 'Identifiant de la politique d&rsquo;archivage');
...
if (!defined('_LC_CYCLE_STEP_ADDED'))  define('_LC_CYCLE_STEP_ADDED', 'Etape de cycle de vie ajout&eacute;e');
if (!defined('_LC_CYCLE_STEP_DELETED'))  define('_LC_CYCLE_STEP_DELETED', 'Etape de cycle de vie supprim&eacute;e');
if (!defined('_LC_CYCLE_STEP_MODIFICATION'))  define('_LC_CYCLE_STEP_MODIFICATION', 'Modification d&rsquo; une &eacute;tape de cycle de vie');
...
if (!defined('_SEQUENCE_NUMBER'))  define('_SEQUENCE_NUMBER', 'Numero de s&eacute;quence');
if (!defined('_BREAK_KEY'))  define('_BREAK_KEY', 'Cl&eacute; de rupture');
if (!defined('_LC_CYCLE_ADDITION'))  define('_LC_CYCLE_ADDITION', 'Ajouter un cycle de vie');
if (!defined('_LC_CYCLE_ADDED'))  define('_LC_CYCLE_ADDED', 'Cycle de vie ajout&eacute;');
...
if (!defined('_LC_POLICY'))  define('_LC_POLICY', 'une politique d&rsquo;archivage');
...
if (!defined('_LC_POLICY_ADDED'))  define('_LC_POLICY_ADDED', 'Politique de cycle de vie ajout&eacute;e');
if (!defined('_LC_POLICY_DELETED'))  define('_LC_POLICY_DELETED', 'Politique de cycle de vie supprim&eacute;e');
if (!defined('_LC_POLICY_MODIFICATION'))  define('_LC_POLICY_MODIFICATION', 'Modification de la politique d&rsquo;archivage');
