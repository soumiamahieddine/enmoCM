            ...
            <form name="formdocserver" method="post" class="forms" action="<?php echo $_SESSION['config']['businessappurl']."index.php?display=true&page=lc_cycle_steps_management_controler&module=life_cycle&mode=".$mode;?>">
                ...
                <?php if($mode == "up") {
                    ...
                    <p>
                        ...
                        <input name="policy_id" type="text"  id="policy_id" value="<?php echo functions::show_str($_SESSION['m_admin']['lc_cycle_steps']['policy_id']); ?>" readonly='readonly' class='readonly'/>
                    </p>
                    <?php
                } else {
                    ?>
                ...
                <?php if(!empty($_SESSION['m_admin']['lc_cycle_steps']['policy_id']) && $mode == "up") {
                    ...
                    <p>
                        ...
                        <input name="cycle_id" type="text"  id="cycle_id" value="<?php echo functions::show_str($_SESSION['m_admin']['lc_cycle_steps']['cycle_id']); ?>" readonly='readonly' class='readonly'/>
                    </p>
                <?php
                } else {
                    ?>
                ...
                <p>
                    ...
                    <input name="id" type="text"  id="id" value="<?php echo functions::show_str($_SESSION['m_admin']['lc_cycle_steps']['cycle_step_id']); ?>" <?php if($mode == "up") echo " readonly='readonly' class='readonly'";?>/>
                </p>
                <p>
                    <label for="cycle_step_desc"><?php echo _CYCLE_STEP_DESC; ?> : </label>
                    <textarea name="cycle_step_desc" type="text" id="cycle_step_desc" value="<?php echo functions::show_str($_SESSION['m_admin']['lc_cycle_steps']['cycle_step_desc']); ?>" ><?php echo $_SESSION['m_admin']['lc_cycle_steps']['cycle_step_desc'];?></textarea>
                </p>
                <p>
                ...
                <p>
                    ...
                    <input name="sequence_number" type="text"  id="sequence_number" value="<?php echo functions::show_str($_SESSION['m_admin']['lc_cycle_steps']['sequence_number']); ?>" />
                </p>
                <p>
                ...
                <p>
                    ...
                    <input name="preprocess_script" type="text"  id="preprocess_script" value="<?php echo functions::show_str($_SESSION['m_admin']['lc_cycle_steps']['preprocess_script']); ?>" />
                </p>
                <p>
                    <label for="postprocess_script"><?php echo _POSTPROCESS_SCRIPT; ?> : </label>
                    <input name="postprocess_script" type="text"  id="postprocess_script" value="<?php echo functions::show_str($_SESSION['m_admin']['lc_cycle_steps']['postprocess_script']); ?>" />
                </p>
                <p class="buttons">
                    <?php
                    if($mode == "up"){
