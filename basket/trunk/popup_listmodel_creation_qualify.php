...
*/
/*
* @brief   Pop up used modify model of the diffusion lists in the qualification service
*
* @file
...
if(isset($_POST['valid']))
{
	...
	//$func->show_array($_SESSION['m_admin']['entity']['listmodel']);
	?>
...
<body>
	<?php
		$link = "popup_listmodel_creation_qualify.php";
		?>
		<br/>
		...
		{ ?>
			...
			<tr <?php echo $color; ?>>
				...
				{
					?>
					<td class="action"><a href="popup_listmodel_creation_qualify.php?what=<?php echo $what;?>&service=true&action=add&id=<?php echo $users[$j]['ID'];?>" class="change"><?php echo _ADD;?></a></td>
					<?php
				}
				else
				{
					?>
					<td class="action"><a href="popup_listmodel_creation_qualify.php?what=<?php echo $what;?>&action=add&id=<?php echo $users[$j]['ID'];?>" class="change"><?php echo _ADD;?></a></td>
					<?php
				}
				?>
			</tr>
		...
		if(count($_SESSION['m_admin']['entity']['listmodel']) > 0)
		{
			...
			<table cellpadding="0" cellspacing="0" border="0" class="listing spec">
			 ...
			 <tr>
				...
				<td class="action"><a href="popup_listmodel_creation_qualify.php?what=<?php echo $what;?>&action=remove&rang=0" class="delete"><?php echo _DELETE;?></a></td>
				<td class="action"><a href="popup_listmodel_creation_qualify.php?what=<?php echo $what;?>&action=down&rang=0" class="down"><?php echo _DOWN;?></a></td>
		 </tr>
	</table>
	<br/><?php
		...
		<table cellpadding="0" cellspacing="0" border="0" class="listing spec">
			...
			for($i=1;$i<count($_SESSION['m_admin']['entity']['listmodel']);$i++)
			{
				...
				<tr <?php echo $color; ?>>
					...
					<td class="action"><a href="popup_listmodel_creation_qualify.php?what=<?php echo $what;?>&action=remove&rang=<?php echo $i;?>" class="delete"><?php echo _DELETE;?></a></td>
					<td class="action"><?php if( $i+1 < count($_SESSION['m_admin']['entity']['listmodel'])) { ?><a href="popup_listmodel_creation_qualify.php?what=<?php echo $what;?>&action=down&rang=<?php echo $i;?>" class="down"><?php echo _DOWN;?></a><?php } else { echo "&nbsp;"; }?></td>
					<td class="action"><a href="popup_listmodel_creation_qualify.php?what=<?php echo $what;?>&action=up&rang=<?php echo $i;?>" class="up"><?php echo _UP;?></a></td>
				</tr>
				<?php
			}
			?>
