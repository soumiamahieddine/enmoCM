...
/*
* @brief  Basket result page :  Displays mails to be process (used in Letterbox application)
*
* @file
...
$param_list = array('values' => $tab, 'title' => _PROCESS_LIST." : ".count($tab)." "._DOCS, 'key' => 'res_id', 'page_name' => 'mail_process',
'what' => 'res_id', 'detail_destination' =>  $_SESSION['config']['businessappurl']."process.php", 'details_page' => '', 'view_doc' => false,  'bool_details' => false, 'bool_order' => true,
