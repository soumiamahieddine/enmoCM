...
// USER ABS
if (!defined('_MY_ABS'))
    define('_MY_ABS', 'Manage my absence');
if (!defined('_MY_ABS_TXT'))
    define('_MY_ABS_TXT', 'Allows you to redirect your baskets while not at the office');
...
if (!defined('_ADMIN_ABS_TXT'))
    define('_ADMIN_ABS_TXT', 'Allows you to redirect this user baskets while not at the office');
...
if (!defined('_MISSING_ADVERT_TITLE'))
    define('_MISSING_ADVERT_TITLE','Absence management');
...
if (!defined('_ABS_MODE'))
    define('_ABS_MODE', 'Absence management');
...
if (!defined('_SPREAD_SEARCH_TO_BASKETS'))
    define('_SPREAD_SEARCH_TO_BASKETS', 'Spread search to baskets');
