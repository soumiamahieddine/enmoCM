...
$app->get('/signatureBook/users/{userId}/groups/{groupId}/baskets/{basketId}/resource/{resId}', \SignatureBook\controllers\SignatureBookController::class . ':getSignatureBook');
