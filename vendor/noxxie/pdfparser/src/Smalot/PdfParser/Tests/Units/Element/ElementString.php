...
class ElementString extends atoum\test
{
    public function testParse()
    {
        // Skipped.
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementString::parse('ABC', null, $offset);
        $this->assert->boolean($element)->isEqualTo(false);
        $this->assert->integer($offset)->isEqualTo(0);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementString::parse(' [ (ABC) 5 6 ]', null, $offset);
        $this->assert->boolean($element)->isEqualTo(false);
        $this->assert->integer($offset)->isEqualTo(0);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementString::parse(' << (invalid) >>', null, $offset);
        $this->assert->boolean($element)->isEqualTo(false);
        $this->assert->integer($offset)->isEqualTo(0);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementString::parse(' / (FlateDecode) ', null, $offset);
        $this->assert->boolean($element)->isEqualTo(false);
        $this->assert->integer($offset)->isEqualTo(0);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementString::parse(' 0 (FlateDecode) ', null, $offset);
        $this->assert->boolean($element)->isEqualTo(false);
        $this->assert->integer($offset)->isEqualTo(0);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementString::parse(" 0 \n (FlateDecode) ", null, $offset);
        $this->assert->boolean($element)->isEqualTo(false);
        $this->assert->integer($offset)->isEqualTo(0);

        // Valid.
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementString::parse(' (Copyright) ', null, $offset);
        ...
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementString::parse('(Copy-right2)', null, $offset);
        $this->assert->string($element->getContent())->isEqualTo('Copy-right2');
        $this->assert->integer($offset)->isEqualTo(13);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementString::parse(" \n (Copyright) ", null, $offset);
        $this->assert->string($element->getContent())->isEqualTo('Copyright');
        $this->assert->integer($offset)->isEqualTo(14);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementString::parse('()', null, $offset);
        ...
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementString::parse("(\xFE\xFF\\000M)", null, $offset);
        $this->assert->string($element->getContent())->isEqualTo('M');
        $this->assert->integer($offset)->isEqualTo(9);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementString::parse("(<20>)", null, $offset);
        $this->assert->string($element->getContent())->isEqualTo(' ');
        $this->assert->integer($offset)->isEqualTo(6);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementString::parse("(Gutter\\ console\\ assembly)", null, $offset);
    ...
    {
        $element = new \Noxxie\PdfParser\Element\ElementString('Copyright');
        $this->assert->string($element->getContent())->isEqualTo('Copyright');
    }
    ...
    public function testEquals()
    {
        ...
        $element = new \Noxxie\PdfParser\Element\ElementString('CopyRight2');
        ...
        $element = new \Noxxie\PdfParser\Element\ElementString('Flate-Decode2');
