...
class ElementName extends atoum\test
{
    public function testParse()
    {
        // Skipped.
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementName::parse('ABC', null, $offset);
        $this->assert->boolean($element)->isEqualTo(false);
        $this->assert->integer($offset)->isEqualTo(0);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementName::parse(' [ /ABC 5 6 ]', null, $offset);
        $this->assert->boolean($element)->isEqualTo(false);
        $this->assert->integer($offset)->isEqualTo(0);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementName::parse(' << invalid >>', null, $offset);
        $this->assert->boolean($element)->isEqualTo(false);
        $this->assert->integer($offset)->isEqualTo(0);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementName::parse(' / FlateDecode ', null, $offset);
        $this->assert->boolean($element)->isEqualTo(false);
        $this->assert->integer($offset)->isEqualTo(0);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementName::parse(' 0 /FlateDecode ', null, $offset);
        $this->assert->boolean($element)->isEqualTo(false);
        $this->assert->integer($offset)->isEqualTo(0);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementName::parse(" 0 \n /FlateDecode ", null, $offset);
        $this->assert->boolean($element)->isEqualTo(false);
        $this->assert->integer($offset)->isEqualTo(0);
        ...
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementName::parse(" \n /FlateDecode ", null, $offset);
        $this->assert->string($element->getContent())->isEqualTo('FlateDecode');
        $this->assert->integer($offset)->isEqualTo(15);

        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementName::parse('/FlateDecode2', null, $offset);
        $this->assert->string($element->getContent())->isEqualTo('FlateDecode2');
        $this->assert->integer($offset)->isEqualTo(13);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementName::parse('/Flate-Decode2', null, $offset);
        $this->assert->string($element->getContent())->isEqualTo('Flate-Decode2');
        $this->assert->integer($offset)->isEqualTo(14);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementName::parse('/OJHCYD+Cambria', null, $offset);
        $this->assert->string($element->getContent())->isEqualTo('OJHCYD+Cambria');
        $this->assert->integer($offset)->isEqualTo(15);
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementName::parse('/OJHCYD+Cambria,Bold', null, $offset);
        $this->assert->string($element->getContent())->isEqualTo('OJHCYD+Cambria,Bold');
        $this->assert->integer($offset)->isEqualTo(20);

        //
        $offset  = 0;
        $element = \Noxxie\PdfParser\Element\ElementName::parse('/Flate_Decode2', null, $offset);
    ...
    {
        $element = new \Noxxie\PdfParser\Element\ElementName('FlateDecode');
        $this->assert->string($element->getContent())->isEqualTo('FlateDecode');
    }
    ...
    public function testEquals()
    {
        ...
        $element = new \Noxxie\PdfParser\Element\ElementName('FlateDecode2');
        ...
        $element = new \Noxxie\PdfParser\Element\ElementName('Flate-Decode2');
