...
case "add_user":
    ...
    usort($_SESSION['m_admin']['entity']['listmodel'][$role_id]['users'], "cmp_users");
    break;
...
case 'add_entity':
    ...
    usort($_SESSION['m_admin']['entity']['listmodel'][$role_id]['entities'], "cmp_entity");   
    break;    
    ...
    <?php $link = $_SESSION['config']['businessappurl']."index.php?display=true&module=entities&page=creation_listmodel";
        ...
        <script type="text/javascript">
            ...
            function add_user(id) {
                ...
                goTo('<?php echo $link; ?>&what_users=<?php echo $whatUsers; ?>&what_services=<?php echo $whatServices; ?>&action=add_user&id='+user_id+'&listinstance_role='+listinstance_role);        
            }
            
            function add_entity(id) {
                entity_id = $('entity_id_' + id).value;
                listinstance_role = $('entity_role_' + id).value;
                goTo('<?php echo $link; ?>&what_users=<?php echo $whatUsers; ?>&what_services=<?php echo $whatServices; ?>&action=add_entity&id='+entity_id+'&listinstance_role='+listinstance_role);        
            }
            ...
            { ?><h2 class="sstit"><?php echo $role_config['list_label'];?></h2>
                ...
                for ($i=0, $l=count($_SESSION['m_admin']['entity']['listmodel'][$role_id]['users']) ; $i<$l ; $i++) {
                    ...
                    <tr <?php echo $color; ?> >
                        ...
                        { ?>
                            <a href="<?php echo $link; ?>&what_users=<?php echo $whatUsers; ?>&what_services=<?php echo $whatServices;?>&action=remove_user&listinstance_role=<?php echo $role_id ?>&rank=<?php echo $i; ?>&id=<?php echo $_SESSION['m_admin']['entity']['listmodel'][$role_id]['users'][$i]['user_id'];?>" class="delete">
                                <?php echo _DELETE; ?>
                            </a><?php
                        } ?>
                        </td>
                ...
                for ($i = 0; $i < count(
                    ...
                    <tr <?php echo $color; ?> >
                        ...
                        <td class="action_entities"><?php if (!$noDelete) 
                        { ?>
                            <a href="<?php echo $link; ?>&what_users=<?php echo $whatUsers; ?>&what_services=<?php echo $whatServices;?>&action=remove_entity&listinstance_role=<?php echo $role_id ?>&rank=<?php echo $i; ?>&id=<?php echo $_SESSION['m_admin']['entity']['listmodel'][$role_id]['entities'][$i]['entity_id'];?>" class="delete">
                                <?php echo _DELETE; ?>
                            </a><?php
                        } ?>
                        </td>
