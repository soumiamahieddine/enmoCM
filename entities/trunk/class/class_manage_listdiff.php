...
class diffusion_list extends dbquery
{
	...
	*/
	public function get_listmodel_from_entity($entity_id, $coll_id = 'letterbox_coll')
	{
		...
		$listmodel['dest']['lastname'] = $this->show_string($res->lastname);
		$listmodel['dest']['firstname'] = $this->show_string($res->firstname);
	...
	**/
	public function get_listinstance($res_id, $mode_cc = false, $coll_id = 'letterbox_coll')
	{
		...
		$this->query("select  l.item_id,  e.entity_label  from ".$_SESSION['tablename']['ent_listinstance']." l, ".$_SESSION['tablename']['ent_entities']." e where l.coll_id = 'letterbox_coll' and l.listinstance_type = 'DOC' and l.item_mode = 'cc' and l.item_type = 'entity_id' and l.item_id = e.entity_id and l.res_id = ".$res_id." order by e.entity_label ");
