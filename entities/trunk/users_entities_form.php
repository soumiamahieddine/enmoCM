...
<?php
	...
	else
	{
		for($theline = 0; $theline < count($_SESSION['m_admin']['entity']['entities']) ; $theline++)
		{
				...
				?>
				<input type="checkbox"  class="check" name="entities[]" value="<?php  echo $_SESSION['m_admin']['entity']['entities'][$theline]['ENTITY_ID']; ?>" ><?php  echo $_SESSION['m_admin']['entity']['entities'][$theline]['LABEL'] ; ?><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i><?php  echo $_SESSION['m_admin']['entity']['entities'][$theline]['ROLE']; ?></i><br/></input>
				<?php
		}
