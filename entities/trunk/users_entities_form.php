...
<?php
    ...
    else
    {
        for($theline = 0; $theline < count($_SESSION['m_admin']['entity']['entities']) ; $theline++)
        {
                ...
                ?>
                <input type="checkbox"  class="check" name="entities[]" value="<?php functions::xecho($_SESSION['m_admin']['entity']['entities'][$theline]['ENTITY_ID']);?>" ><?php if(isset($_SESSION['m_admin']['entity']['entities'][$theline]['SHORT_LABEL']) && !empty($_SESSION['m_admin']['entity']['entities'][$theline]['SHORT_LABEL'])){ echo $_SESSION['m_admin']['entity']['entities'][$theline]['SHORT_LABEL'] ; }elseif(isset($_SESSION['m_admin']['entity']['entities'][$theline]['LABEL'])){ echo $_SESSION['m_admin']['entity']['entities'][$theline]['LABEL'];}?><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i><?php echo $_SESSION['m_admin']['entity']['entities'][$theline]['ROLE'];?></i><br/></input>
                <?php
        }
