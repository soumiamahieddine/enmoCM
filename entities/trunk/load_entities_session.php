<?php
	...
	{
		$xml = simplexml_load_file("modules/entities/xml/redirect_keywords.xml");
		$_SESSION['m_admin']['redirect_keywords'] = array();
		$path_lang = "modules/entities".DIRECTORY_SEPARATOR.'lang'.DIRECTORY_SEPARATOR.$_SESSION['config']['lang'].'.php';
