...
if (!defined('_CASE_INFO'))
    define('_CASE_INFO', 'Informations sur l&rsquo;affaire');
...
if (!defined('_CASE_ID'))
    define('_CASE_ID','Identifiant de l&rsquo;affaire');
if (!defined('_CASE_LABEL'))
    define('_CASE_LABEL','Libell&eacute; de l&rsquo;affaire');
if (!defined('_CASE_DESCRIPTION'))
    define('_CASE_DESCRIPTION','Description de l&rsquo;affaire');
if (!defined('_CASE_TYPIST'))
    define('_CASE_TYPIST','Cr&eacute;ateur de l&rsquo;affaire');
if (!defined('_CASE_CREATION_DATE'))
    define('_CASE_CREATION_DATE','Date de cr&eacute;ation');
if (!defined('_CASE_LAST_UPDATE_DATE'))
    define('_CASE_LAST_UPDATE_DATE','Derni&egrave;re mise &agrave; jour');
if (!defined('_CASE_CLOSING_DATE'))
    define('_CASE_CLOSING_DATE','Date de cl&ocirc;ture');
...
if (!defined('_UPDATE_CASE'))
    define('_UPDATE_CASE','Mise &agrave; jour d&rsquo;affaires');
if (!defined('_NEW_CASE'))
    define('_NEW_CASE','Nouvelle affaire');
if (!defined('_RES_ATTACH_ON_CASE'))
    define('_RES_ATTACH_ON_CASE','Document attach&eacute; &agrave; l&rsquo;affaire');
if (!defined('_RES_DETTACH_ON_CASE'))
    define('_RES_DETTACH_ON_CASE','Document dettach&eacute; &agrave; l&rsquo;affaire');
...
if (!defined('_JOIN_RES_ON_THIS_CASE'))
    define('_JOIN_RES_ON_THIS_CASE','Attacher un document &agrave; l&rsquo;affaire');
if (!defined('_RESSOURCES_LINKED'))
    define('_RESSOURCES_LINKED','Document attach&eacute;');
if (!defined('_RESSOURCES_NOT_LINKED'))
    define('_RESSOURCES_NOT_LINKED','Ce document est d&eacute;j&agrave; attach&eacute;');
if (!defined('_CASE'))
...
if (!defined('_LINK_TO_CASE'))
    define('_LINK_TO_CASE','Attacher &agrave; l&rsquo;affaire');
