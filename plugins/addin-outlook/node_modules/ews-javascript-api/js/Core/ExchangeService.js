...
var ExchangeService = /** @class */ (function (_super) {
    ...
    function ExchangeService() {
        ...
        _this.enableScpLookup = false; //false for javascript, AD Lookup not implemented 
    ...
    Object.defineProperty(ExchangeService.prototype, "Url", {
        //#endregion
        //#region Properties
        /**
    ...
    Object.defineProperty(ExchangeService.prototype, "ImpersonatedUserId", {
        /**
    ...
    Object.defineProperty(ExchangeService.prototype, "PrivilegedUserId", {
        /**
    ...
    Object.defineProperty(ExchangeService.prototype, "ManagementRoles", {
        /**
         * [summary]
         */
        get: function () {
    ...
    Object.defineProperty(ExchangeService.prototype, "DateTimePrecision", {
        // /**
    ...
    Object.defineProperty(ExchangeService.prototype, "FileAttachmentContentHandler", {
        /**
    ...
    Object.defineProperty(ExchangeService.prototype, "Exchange2007CompatibilityMode", {
        /**
    ...
    Object.defineProperty(ExchangeService.prototype, "TraceEnablePrettyPrinting", {
        /**
    ...
    ExchangeService.prototype.AutodiscoverUrl = function (emailAddress, validateRedirectionUrlCallback) {
        ...
        if (this.RequestedServerVersion > ExchangeVersion_1.ExchangeVersion.Exchange2007_SP1) {
            return this.GetAutodiscoverUrl(emailAddress, this.RequestedServerVersion, validateRedirectionUrlCallback).then(function (url) {
                ...
                return _this.GetAutodiscoverUrl(emailAddress, ExchangeVersion_1.ExchangeVersion.Exchange2007_SP1, validateRedirectionUrlCallback).then(function (url) {
        ...
        // Try legacy Autodiscover provider
        return this.GetAutodiscoverUrl(emailAddress, ExchangeVersion_1.ExchangeVersion.Exchange2007_SP1, validateRedirectionUrlCallback).then(function (url) {
            _this.Url = _this.AdjustServiceUriFromCredentials(url);
        }, function (error) {
            throw error;
        });
    ...
    ExchangeService.prototype.GetAutodiscoverUrl = function (emailAddress, requestedServerVersion, validateRedirectionUrlCallback) {
        var _this = this;
        var autodiscoverService = new AutodiscoverService_1.AutodiscoverService(this, requestedServerVersion);
