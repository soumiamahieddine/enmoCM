...
var EwsUtilities = /** @class */ (function () {
    ...
    EwsUtilities.FormatHttpHeaders = function (headers) {
     ...
     */
    EwsUtilities.FormatHttpRequestHeaders = function (request) {
        var sb = ExtensionMethods_1.StringHelper.Format("{0} {1} HTTP/1.1\n", request.type, request.url);
     ...
     */
    EwsUtilities.FormatHttpResponseHeaders = function (response) {
        var sb = ExtensionMethods_1.StringHelper.Format("HTTP/{0} {1} {2}\n", 1 /*response.ProtocolVersion*/, response.status, response.statusText);
     ...
     */
    EwsUtilities.FormatLogMessage = function (entryKind, logEntry) {
        return "\n      <" + entryKind + ">\n        " + logEntry + "\n      </" + entryKind + ">\n    ";
    };
    /**
     ...
     * @return  {string}          XML log entry as a string.
     */
    EwsUtilities.FormatLogMessageWithXmlContent = function (entryKind, memoryStream) {
...
//# sourceMappingURL=EwsUtilities.js.map