...
/**
 * Fills textarea field in the search form whith value
 *
 * @param values Array Values of the search criteria which must be displayed
 **/
...
/**
 * Fills address fields in the search form whith values
 *
 * @param values Array Values of the search criteria which must be displayed
 **/
...
/**
 * Fills input text or selects an item in a list in the search form
 *
 * @param values Array Values of the search criteria which must be displayed
 **/
...
/**
 * Selects an item in a list and fills inputs text in the search form
 *
 * @param values Array Values of the search criteria which must be displayed
 **/
...
/**
 * Checks radio button in the search form
 *
 * @param values Array Values of the search criteria which must be displayed
 **/
