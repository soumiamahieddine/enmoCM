...
(function() {
  ...
  this.Chosen = (function(_super) {
    ...
    Chosen.prototype.set_default_values = function() {
      ...
      this.single_temp = new Template('<a class="chosen-single chosen-default"><span title="">#{default}</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off" /></div><ul class="chosen-results"></ul></div>');
    ...
    Chosen.prototype.choice_build = function(item) {
      var choice, close_link,
        _this = this;
      str_label=this.choice_label(item).replace(/^\s+/g, '').replace(/\s+$/g, '').replace(/&nbsp;/gi,'');
      choice = new Element('li', {
        "class": "search-choice",
        style : 'display: table;padding:2px;width:auto;',
        title : str_label,
      }).update("<span style='display:table-cell;vertical-align:middle;width:auto;padding-right:5px;'>" + (str_label) + "</span>");
      if (item.disabled) {
        ...
        close_link = new Element('a', {
          href: '#',
          "class": 'fa fa-remove',
          style : 'display: table-cell;vertical-align: middle;font-size: 15px;',
          rel: item.array_index
        });
        str_comp = 'thesaurus';
        if( str_comp.indexOf(this.form_field.id) != -1) {
          info_link = new Element('a', {
         
            "class": 'fa fa-info-circle',
            id: 'thesaurus_chosen_'+item.value,
            title : 'en savoir plus',
            style : 'display: table-cell;vertical-align: middle;font-size: 15px;',
            rel: item.array_index
          });
          launch_thesaurus_tooltips(info_link, info_link, str_label);       
          choice.insert(info_link);
        }
    ...
    Chosen.prototype.single_set_selected_text = function(text) {
      ...
      title = text.replace(/^\s+/g, '').replace(/\s+$/g, '').replace(/&nbsp;/gi,'');
      this.selected_item.down("span").title=title;
      return this.selected_item.down("span").update(title);
    };
