        ...
        <br /><br />
            ...
            else
            {
                ...
                <form name="frmaction" id="frmaction" method="post" action="<?php echo $_SESSION['config']['businessappurl']."index.php?display=true&admin=action&page=action_up_db";?>" class="forms addforms">
                   ...
                   <input type="hidden" name="id" id="id" value="<?php if(isset($_SESSION['m_admin']['action']['ID'])){echo $_SESSION['m_admin']['action']['ID'];}?>" />
                    ...
                    <p>
                        ...
                        <select name="status" id="status">
                            ...
                            <?php
                                ...
                                {
                                    ?><option value="<?php echo $arr_status[$i]['id'];?>" <?php if(isset($_SESSION['m_admin']['action']['ID_STATUS']) && $_SESSION['m_admin']['action']['ID_STATUS'] == $arr_status[$i]['id']) { echo 'selected="selected"';}?>><?php echo $arr_status[$i]['label'];?></option><?php
                                }
                            ?>
                        </select>
