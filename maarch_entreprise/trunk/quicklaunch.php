...
<?php
    ...
    foreach ($menu_array as $element) {
        ...
        if ($_SESSION['user']['UserId'] <> 'superadmin' && ($element['id'] == 'index_mlb' && $element['show'] == true &&
            ...
            echo '<div class="quiclaunch_div bighome_indexing"><a href="index.php?page=view_baskets&amp;module=basket&amp;baskets=IndexingBasket"><span>'
                ._INDEXING_MLB.'</span></a></div>';
            $nb_max++;
        ...
        if ($element['id'] == 'adv_search_mlb' && $element['show'] == true &&
            ...
            echo '<div class="quiclaunch_div bighome_search_adv"><a href="index.php?page=search_adv&amp;dir=indexing_searching&amp;reinit=true"><span>'
                ._ADV_SEARCH_MLB.'</span></a></div>';
            $nb_max++;
        ...
        if ($_SESSION['user']['UserId'] <> 'superadmin' && ($element['id'] == 'index_business' && $element['show'] == true &&
            ...
            echo '<div class="quiclaunch_div bighome_indexing"><a href="index.php?page=view_baskets&amp;module=basket&amp;baskets=businessIndexation"><span>'
                ._INDEXING_BUSINESS.'</span></a></div>';
            $nb_max++;
        ...
        if ($element['id'] == 'adv_search_business' && $element['show'] == true &&
            ...
            echo '<div class="quiclaunch_div bighome_search_adv"><a href="index.php?page=search_adv_business&amp;dir=indexing_searching&amp;reinit=true"><span>'
                ._ADV_SEARCH_BUSINESS.'</span></a></div>';
            $nb_max++;
        ...
        if ($element['id'] == 'adv_search_rm' && $element['show'] == true &&
            ...
            echo '<div class="quiclaunch_div bighome_search_adv"><a href="index.php?page=search_adv_rm&amp;module=records_management&amp;reinit=true"><span>'
            ._ADV_SEARCH_RM.'</span></a></div>';
            $nb_max++;
        ...
        if ($element['id'] == 'physical_archive' && $element['show'] == true && (!isset($displayed_physical_archive) || isset($displayed_physical_archive) && $displayed_physical_archive <> true)) {
            echo '<div class="quiclaunch_div bighome_physical_archive"><a href="index.php?page=boxes&amp;module=physical_archive&amp;reinit=true"><span>'
                ._PHYSICAL_ARCHIVE.'</span></a></div>';
            $nb_max++;
