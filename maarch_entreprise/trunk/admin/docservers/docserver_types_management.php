        ...
        if($state == false){
            ...
            <form name="formdocserver" method="post" class="forms" action="<?php echo $_SESSION['config']['businessappurl']."index.php?display=true&page=docserver_types_management_controler&admin=docservers&mode=".$mode;?>">
                ...
                <p>
                    ...
                    <input name="id" type="text"  id="id" value="<?php echo functions::show_str($_SESSION['m_admin']['docserver_types']['docserver_type_id']); ?>" <?php if($mode == "up") echo " readonly='readonly' class='readonly'";?>/>
                </p>
                <p>
                    <label for="docserver_type_label"><?php echo _DOCSERVER_TYPE_LABEL; ?> (*): </label>
                    <input name="docserver_type_label" type="text"  id="docserver_type_label" value="<?php echo functions::show_str($_SESSION['m_admin']['docserver_types']['docserver_type_label']); ?>"/>
                </p>
                <p>
                ...
                <p>
                    ...
                    <input name="container_max_number" type="text"  id="container_max_number" value="<?php echo functions::show_str($_SESSION['m_admin']['docserver_types']['container_max_number']); ?>"/>
                </p>
                </div>
                <p>
