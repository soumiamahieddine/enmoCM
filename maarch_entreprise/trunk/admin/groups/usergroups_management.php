...
if($mode == "list")
{
    list_show::admin_list(
                    ...
                    _ALL_GROUPS,
                    _GROUP,
                    $_SESSION['config']['businessappurl'].'static.php?filename=manage_groups_b.gif',
                    false,
                    true,
                    false,
                    true,
...
elseif($mode == "up" || $mode == "add")
{
    ...
    <div id="inner_content" class="clearfix">
                         ...
                         for($i=0;$i<count($users);$i++)
                            {
                                ...
                                else
                                {
                                    ...
                                    ?>
                             <tr <?php  echo $color; ?> >
                                       <td style="width:25%;"><?php  echo $users[$i]->__get('lastname');?></td>
                                        <td style="width:25%;"><?php  echo $users[$i]->__get('firstname');?></td>
                                     <!--  <td><?php  //echo $users[$i]['DEPARTMENT']; ?></td>-->
                                       <td ><?php
                                        if(core_tools::test_service('admin_users', 'apps', false))
                                        {?>
                                       <a class="change" href="<?php echo $_SESSION['config']['businessappurl'].'index.php?page=users_management_controler&amp;mode=up&amp;admin=users&amp;id='.$users[$i]->__get('user_id'); ?>"  title="<?php echo _GO_MANAGE_USER;?>"><i><?php echo _GO_MANAGE_USER;?></i></a><?php }?></td>
                            </tr>
                                    <?php
                            }
                        ?>
                         ...
                         for($i=0;$i<count($baskets);$i++)
                            {
                                ...
                                else
                                {
                                    ...
                                    ?>
                             <tr <?php  echo $color; ?> >
                                       <td style="width:30%;"><?php  echo $baskets[$i]->__get('basket_name');?></td>
                                      <td style="width:50%;"><?php  echo $baskets[$i]->__get('basket_desc');?></td>
                                       <td >
                                       <?php if(core_tools::test_service('admin_baskets', 'basket', false))
                                        {?>
                                        <a class="change" href="<?php echo $_SESSION['config']['businessappurl'].'index.php?page=basket_up&module=basket&id='.$baskets[$i]->__get('basket_id'); ?>" title="<?php echo _GO_MANAGE_BASKET;?>"><i><?php echo _GO_MANAGE_BASKET;?></i></a>
                                       <?php } ?>
                                        </td>
                            </tr>
                                    <?php
        ...
        <form id="formgroup" method="post"  class="forms" action="<?php echo  $_SESSION['config']['businessappurl']."index.php?display=true&admin=groups&page=usergroups_management_controler&mode=".$mode ?>" >
            <div>
                ...
                <table border="0" summary="">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            if(isset($_SESSION['m_admin']['groups']['group_desc'])){ echo $_SESSION['m_admin']['groups']['group_desc'];} ?>"  alt="<?php  if(isset($_SESSION['m_admin']['groups']['group_desc'])) {echo $_SESSION['m_admin']['groups']['group_desc']; }?>" title="<?php if(isset($_SESSION['m_admin']['groups']['group_desc'])) { echo $_SESSION['m_admin']['groups']['group_desc'];} ?>"/>
                        </td>
                    </tr>
                </table>
                <br/><div class="center_text"><i><?php  echo _AVAILABLE_SERVICES;?> :</i></div>
                <?php
                        ...
                        <div class="desc block_light admin" id="desc<?php  echo $_SESSION['cpt'];?>" style="display:none">
                            <div class="ref-unit">
                                ...
                                for($i=0; $i<count($enabled_services_sort_by_parent[$value]); $i++)
                                {
                                    ...
                                    ?>
                                    <tr>
                                        <td style="width:800px;" align="right" title="<?php  echo $enabled_services_sort_by_parent[$value][$i]['comment'];?>">
