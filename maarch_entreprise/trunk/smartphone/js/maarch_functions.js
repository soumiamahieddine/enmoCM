function modify_contact_smartphone(url,
                    lastname,
                    firstname,
                    phone,
                    email,
                    ...
                    address_country,
                    id){
    if (window.confirm('Voulez-vous vraiment modifier le contact?'))
    {
      alert(
        url
      +',\nlastname : '+lastname+',\nfirstname :  '+firstname+',\nphone : '+phone
      +',\nemail : '+email+',address_num : '+address_num+',\naddress_street : '+address_street
      ...
      
      {
          ...
          onSuccess: function(answer){
              ...
              if (response.status == 'ok') {
                ...
                window.location.href = response.content+"smartphone/index.php?page=welcome#_home";
