...
echo '<form id="formlogin" method="post" action="'
    ...
    echo '" class="forms">';
            ...
            echo '<p>';
                echo '<label for="login" style="font-size:16px;">'._ID.'</label>';
                echo '<input name="login" id="login" value="" type="text"  />';
            echo '</p>';
			echo '<br>';
            echo '<p>';
                echo '<label for="pass" style="font-size:16px;">'._PASSWORD.'</label>';
                echo '<input name="pass" id="pass" value="" type="password"  />';
            echo '</p>';
            echo '<br>';
            echo '<p class="buttons">';
                echo '<input type="submit" class="button" name="submit" value="Connexion" />';
            echo '</p>';
