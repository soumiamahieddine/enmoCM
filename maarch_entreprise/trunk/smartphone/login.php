...
<html manifest="iphone.manifest">
    ...
    <body>
            ...
            <fieldset>
					...
					<table>
						<tr>
							...
							<td style="width:50%;">
								<input style="text-align:left;" type="text" name="login" value="" style="width:100%;"/>
							</td>
						</tr>
					<tr>
                    <td colspan="2"></td>
        ...
        <div class="toolbar" style="color:white;border-bottom: 1px solid #FDD16C;display: block;position: absolute;border: 0px;height: auto;bottom: 0px;width: 100%;padding: 10px;font-size: 8px;text-align: center;">
