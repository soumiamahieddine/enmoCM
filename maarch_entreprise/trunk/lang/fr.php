...
if (!defined('_ALREADY_CREATED_AND_DELETED')) define( '_ALREADY_CREATED_AND_DELETED', 'd&eacute;j&agrave; cr&eacute;&eacute; puis supprim&eacute;');
...
if (!defined('_SELECT_CONTACT_TO_REPLACE'))  define('_SELECT_CONTACT_TO_REPLACE', 'S&eacute;lectionner le contact et l\'adresse rempla&ccedil;ant');
if (!defined('_ARE_YOU_SURE_TO_DELETE_CONTACT'))  define('_ARE_YOU_SURE_TO_DELETE_CONTACT', '&Ecirc;tes vous s&ucirc;r de supprimer le contact ?');
if (!defined('_CONTACT_CHECK'))  define('_CONTACT_CHECK', 'Au moins un courrier enregistr&eacute; r&eacute;cemment est affect&eacute; au m&ecirc;me contact.');
...
if (!defined('_ATTACHMENT_TYPE')) define( '_ATTACHMENT_TYPE', 'Type de pi&egrave;ce jointe');
...
if (!defined('_ENTER_REF_ID_OR_GED_ID')) define( '_ENTER_REF_ID_OR_GED_ID', 'Saisissez le n&deg; chrono ou le n&deg; GED du document');
if (!defined('_REF_ID')) define( '_REF_ID', 'n&deg; chrono');
...
if (!defined('_ADMIN_LISTS_DESC'))                  define('_ADMIN_LISTS_DESC', 'D&eacute;finir les listes de resultats.');
...
if (!defined('_SEND_SIGNED_DOCS'))    define( '_SEND_SIGNED_DOCS', 'Transmettre r&eacute;ponses sign&eacute;es');
