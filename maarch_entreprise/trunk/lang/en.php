...
if (!defined('_DOCSERVER_TYPE_ADDITION'))  define('_DOCSERVER_TYPE_ADDITION', 'Storage zone type addition');
...
if (!defined('_MANAGE_MEP_RELEASE'))     define( '_MANAGE_MEP_RELEASE', 'Manage Maarch Entreprise releases');
