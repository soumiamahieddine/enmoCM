...
elseif($_SESSION['service_tag'] == 'frm_doctype')
{
	...
	<p>
		...
		<input name="process_delay" type="text" class="textbox" id="label" maxlength="2" value="<?php echo $func->show($_SESSION['m_admin']['doctypes']['process_delay']); ?>"/>
	</p>
	<p>
		<label for="label"><?php echo _ALARM1_DELAY; ?> : </label>
		<input name="delay1" type="text" class="textbox" id="label" maxlength="2" value="<?php echo $func->show($_SESSION['m_admin']['doctypes']['delay1']); ?>"/>
	</p>
	<p>
