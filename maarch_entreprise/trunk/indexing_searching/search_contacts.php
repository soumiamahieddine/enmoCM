...
<?php } ?>
<form name="frmsearch2" method="get" action="<?php echo $_SESSION['config']['businessappurl'].'index.php?display=true&dir=indexing_searching&page=search_contact_result';?>"  id="frmsearch2" class="<?php echo $class_for_form; ?>">
    ...
    <tr >
        ...
        <div class="block">
            <table border = "0" width="100%">
                <tr>
                    <td width="70%"><label for="contact_type" class="bold" ><?php echo _CONTACT_TYPE;?> :</label>
                ...
                <tr>
                    <td width="70%"><label for="society" class="bold" ><?php echo _SOCIETY;?> :</label>
                ...
                <tr>
                    <td width="70%"><label for="created_by" class="bold"><?php echo _CREATE_BY;?> :</label>
                        <input type="text" name="created_by" id="created_by" onkeyup="erase_contact_external_id();"/>
                ...
                <tr>
                    <td width="70%"><label for="contact_purpose" class="bold"><?php echo _CONTACT_PURPOSE;?> :</label>
                        <input type="text" name="contact_purpose" id="contact_purpose" />
...
<select name="select_criteria" id="select_criteria" style="display: none;">
</select>
