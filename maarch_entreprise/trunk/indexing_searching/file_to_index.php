...
if(!empty($_FILES['file']['tmp_name']) )
{
	...
	if(!move_uploaded_file($_FILES['file']['tmp_name'], '..'.DIRECTORY_SEPARATOR.'tmp'.DIRECTORY_SEPARATOR.'tmp_file_'.$_GET['md5'].'.'.$the_ext))
	{
	...
	$_SESSION['upfile']['local_path'] = '..'.DIRECTORY_SEPARATOR.'tmp'.DIRECTORY_SEPARATOR.'tmp_file_'.$_GET['md5'].'.'.$the_ext;
