...
if($mode == 'normal') {
    ...
    $page_path = $_SESSION['config']['businessappurl'].'index.php?page=list_results_business&dir=indexing_searching';
    $page_label = _RESULTS;
    $page_id = "search_adv_result_business";
...
//List
$target = $_SESSION['config']['businessappurl'].'index.php?page=documents_list_business_search_adv&dir=indexing_searching'.$urlParameters;
