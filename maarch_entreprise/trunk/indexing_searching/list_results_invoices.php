...
$list->list_doc($tab, $i, '', 'res_id', $name, 'res_id', 'details_invoices&dir=indexing_searching', true, $bool_radio_form, $method, $action, $button_label, $show_details, true, $special, $export, $show_close, false, true, false, '', '', false, '', '', 'listing spec', $comp_link, false, false, array (), $hidden_fields, '{}', false, '', true, array (), $use_template, $template_list, $template_to_use);
?></div><?php
