...
if (empty ($_SESSION['error']) || $_SESSION['indexation']) {
    ...
    $db->query("select status, format, typist, creation_date,  fingerprint,  filesize, res_id, work_batch,  page_count, is_paper, scan_date, scan_user, scan_location, scan_wkstation, scan_batch, source, doc_language, description " . $comp_field . $case_sql_complementary . " from " . $table . " where res_id = " . $s_id . "");
    //$db->show();
}
?>
...
<div id="details_div" >
    ...
    <div id="inner_content" class="clearfix">
        ...
        ?>
                                ...
                                <tr class="col">
                                    <th align="left" class="picto">
                                        <img alt="<?php echo _PAGE_COUNT; ?>" src="<?php echo $_SESSION['config']['businessappurl'];?>static.php?filename=mini_type.gif" />
                                    </th>
                                    <td align="left" width="200px">
                                        <?php  echo _PAGE_COUNT; ?> :
                                    </td>
                                    <td>
                                        <input type="text" class="readonly" readonly="readonly" value="<?php  echo $page_count; ?>" size="40" title="<?php  echo $page_count; ?>" alt="<?php  echo $page_count; ?>" />
                                    </td>
