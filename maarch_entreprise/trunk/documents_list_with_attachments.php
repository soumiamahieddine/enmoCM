...
if (empty($_SESSION['auth_dep']['bask_chosen_entity'])
    ...
    ?>';
    new Ajax.Request(
        '<?php echo $_SESSION['config']['businessappurl'];?>index.php?display=true&page=manage_filter&attachments=true&origin=<?php echo $_REQUEST['origin'];?>',
        {
          method: 'post',
          parameters: {
              start : startVal,
...
echo $_SESSION['config']['businessappurl'];
?>index.php?display=true&page=manage_filter&attachments=true&origin=<?php echo $_REQUEST['origin']?>');" onBlur="change_contact(this.value, '<?php
echo $_SESSION['config']['businessappurl'];
?>index.php?display=true&page=manage_filter&attachments=true&origin=<?php echo $_REQUEST['origin']?>');"  />
