...
if (!defined("_MESSAGE_IDENTIFIER"))
    define("_MESSAGE_IDENTIFIER", "Message identifier");
if (!defined("_ARCHIVAL_AGENCY_SIREN"))
    define("_ARCHIVAL_AGENCY_SIREN", "Archival agency SIREN");
if (!defined("_TRANSFERRING_AGENCY_SIREN"))
    define("_TRANSFERRING_AGENCY_SIREN", "Transferring agency SIREN");
...
if (!defined("_INFORMATION_ARCHIVE_CHILDREN"))
    define("_INFORMATION_ARCHIVE_CHILDREN", "Children archive information");

if (!defined("_ZIP"))
    define("_ZIP", "Download Zip");
if (!defined("_SEND_MESSAGE"))
    define("_SEND_MESSAGE", "Transfer message");
if (!defined("_VALIDATE"))
    define("_VALIDATE", "Validate");

if (!defined("_RECEIVED_MESSAGE"))
    define("_RECEIVED_MESSAGE", "Confirm compliance message by acknowledgement : ");
