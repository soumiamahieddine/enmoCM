...
/**
* @brief   Displays diffusion list history for avis
*
* @file
...
//Query
    $tab=$request->PDOselect($select, $where_request, $arrayPDO, $orderstr, $_SESSION['config']['databasetype'], "default", false, "", "", "", false, false, false, $start);
    // $request->show();
