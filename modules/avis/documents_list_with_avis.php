...
array_push(
    ...
    'exp_user_id', 'doc_custom_n1 as count_attachment', 'alt_identifier', 'is_multicontacts', 'locker_user_id', 'locker_time', 'address_id', 'filename'
);
...
$template_list = array();
array_push($template_list, 'documents_list_with_avis');
