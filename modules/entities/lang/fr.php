...
if (!defined('_MANAGE_LISTMODELS_DESC')) {
    define('_MANAGE_LISTMODELS_DESC', "Gérer les modèles de circuits d'avis et de visa pouvant être utilisés dans un courrier.");
}
...
if (!defined('_ADMIN_DIFFLIST_TYPES_DESC')) {
    define('_ADMIN_DIFFLIST_TYPES_DESC', 'Administrer les différents types de liste de diffusion');
}
if (!defined('_ADMIN_LISTMODELS')) {
    define('_ADMIN_LISTMODELS', 'Modèle de diffusion (Administration)');
}
if (!defined('_ADMIN_LISTMODELS_DESC')) {
    define('_ADMIN_LISTMODELS_DESC', 'Administrer les différents modèles de diffusion');
}
