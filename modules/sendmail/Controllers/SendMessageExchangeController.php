...
class SendMessageExchangeController
{
    public static function createMessageExchange($aArgs = [])
    {
        ...
        if (!empty($aArgs['join_attachment'])) {
            $AttachmentsInfo = \Attachment\models\AttachmentModel::getOnView(['where' => ['res_id in (?)'], 'data' => [$aArgs['join_attachment']]]);
        ...
        if (!empty($aArgs['join_version_attachment'])) {
            $AttVersionInfo = \Attachment\models\AttachmentModel::getOnView(['where' => ['res_id_version in (?)'], 'data' => [$aArgs['join_version_attachment']]]);
