...
/** SOAP_Value */
require_once 'apps/maarch_entreprise/tools/PEAR/SOAP/Value.php';
require_once 'apps/maarch_entreprise/tools/PEAR/SOAP/Base.php';
require_once 'apps/maarch_entreprise/tools/PEAR/SOAP/Transport.php';
require_once 'apps/maarch_entreprise/tools/PEAR/SOAP/WSDL.php';
require_once 'apps/maarch_entreprise/tools/PEAR/SOAP/Fault.php';
require_once 'apps/maarch_entreprise/tools/PEAR/SOAP/Parser.php';
...
class SOAP_Client extends SOAP_Client_Overload
{
    ...
    {
        $SOAP_Base = new SOAP_Base('Client');
    ...
    function call($method, $params, $namespace = false, $soapAction = false)
    {
        ...
        if (!$this->_soap_transport ||
            ...
            $SOAP_TransportObj = new SOAP_Transport();
            $this->_soap_transport = $SOAP_TransportObj->getTransport($this->_endpoint);
