    ...
    if ($state == false) {
        ...
        if ($mode == 'up') {
            if (count($docservers) > 0) {
                ...
                &nbsp;<i class="fa fa-cogs fa-2x"></i><i onmouseover="this.style.cursor='pointer';"><?php
                echo _SEE_DOCSERVERS_LOCATION; ?></i> <i class="fa fa-arrow-right"></i>
                ...
                for ($i = 0; $i < count($docservers); ++$i ) {
                    ...
                    functions::xecho($docservers[$i]->__get('docserver_id')); ?></td>
                    <td style="width:25%;"><?php
                    functions::xecho($docservers[$i]->__get('device_label')); ?></td>
                    <td style="width:25%;"><?php
                    functions::xecho($docservers[$i]->__get('docserver_type_id')); ?></td>
                    <td ><?php
                    if ($coreTools->test_service('admin_docservers', 'apps', false)
                        ...
                        echo $_SESSION['config']['businessappurl']
                            ...
                            .$docservers[$i]->__get('docserver_id'); ?>"  title="<?php echo _GO_MANAGE_DOCSERVER; ?>"><i><?php
                        echo _GO_MANAGE_DOCSERVER; ?></i></a><?php
                    } ?></td>
                    </tr>
                    <?php
                } ?>
        ...
        echo $_SESSION['config']['businessappurl']; ?>index.php?page=docserver_locations_management_controler&amp;admin=docservers&amp;mode=list';"/>
        </p>
        </form>
        </div>
        </div>
