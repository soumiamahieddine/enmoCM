...
<div id="sign_main_panel" title="<?php functions::xecho($subject); ?>" class="panel" style="height:100%;"> 
    ...
    <div id="signature-pad" class="m-signature-pad" >
        ...
        <div class="m-signature-pad--footer">
          ...
          <span class="action_but_sign saveBut disabled_but" data-action="saveBut" id="saveBut"><i class="fa fa-hand-point-up fa-2x" aria-hidden="true"></i>Signer <span id="loading_sign" style="display:none;"><i class="fa fa-spinner fa-pulse fa-2x fa-fw"></i></span></span>
        </div>
    </div>  
