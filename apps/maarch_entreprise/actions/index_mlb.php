...
function get_form_txt($values, $pathManageAction,  $actionId, $table, $module, $collId, $mode )
{
    ...
    $frmStr .= '</tr>';
    $frmStr .= '<script>new Chosen($j(\'#category_id\')[0],{width: "226px", disable_search_threshold: 10, search_contains: true});</script>';
    /*** Doctype ***/
    ...
    $frmStr .= '<td><span class="red_asterisk" id="type_id_mandatory" '
            . 'style="display:inline;vertical-align:text-top"><i class="fa fa-star"></i></span></td>';
    $frmStr .= '</tr>';
    $frmStr .= '<script>new Chosen($j(\'#type_id\')[0],{width: "226px", disable_search_threshold: 10, search_contains: true});</script>';
    ...
    $frmStr .= '<td><span class="red_asterisk" id="priority_mandatory" '
            . 'style="display:inline;vertical-align:text-top"><i class="fa fa-star"></i></span></td>';
    $frmStr .= '</tr>';
    $frmStr .= '<script>new Chosen($j(\'#priority\')[0],{width: "226px", disable_search_threshold: 10, search_contains: true});</script>';
    ...
    $frmStr .= '<td><span class="red_asterisk" id="nature_id_mandatory" '
            . 'style="display:inline;"><i class="fa fa-star"></i></span>&nbsp;</td>';
    $frmStr .= '</tr>';
    $frmStr .= '<script>new Chosen($j(\'#nature_id\')[0],{width: "226px", disable_search_threshold: 10, search_contains: true});</script>';
    ...
    if ($core->is_module_loaded('entities')) {
        ...
        $frmStr .= '</td>';
        $frmStr .= '</tr>';
        $frmStr .= '<script>new Chosen($j(\'#destination\')[0],{width: "226px", disable_search_threshold: 10, search_contains: true});</script>';
    }
    ...
    if(count($statuses) > 0) {
        ...
        $frmStr .= '</select></td><td><span class="red_asterisk" id="market_mandatory" '
                . 'style="display:inline;"><i class="fa fa-star"></i></span>&nbsp;</td>';
        $frmStr .= '</tr>';
        $frmStr .= '<script>new Chosen($j(\'#status\')[0],{width: "226px", disable_search_threshold: 10, search_contains: true});</script>';
    }
    ...
    if ($core->is_module_loaded('folder') && ($core->test_service('associate_folder', 'folder',false) == 1)) {
        ...
        $frmStr .= '<script>new Chosen($j(\'#folder\')[0],{width: "226px", disable_search_threshold: 10, search_contains: true});</script>';
    }
    ...
    if ($core->is_module_loaded('thesaurus') && $core->test_service('thesaurus_view', 'thesaurus', false)) {
        ...
        $frmStr .= '</tr>';
        $frmStr .= '<script>new Chosen($j(\'#thesaurus\')[0],{width: "226px", disable_search_threshold: 10, search_contains: true});</script>';
