...
if (!defined("_ARE_NOW_LINK_WITH_THIS_ONE"))    define("_ARE_NOW_LINK_WITH_THIS_ONE", " sont maintenant liés à ce document");
...
if (!defined("_THE_DOCUMENTS_LINK"))    define("_THE_DOCUMENTS_LINK", "Les documents ");
