...
if (!defined('_ADMIN_TEMPLATE_ANSWER'))
    define('_ADMIN_TEMPLATE_ANSWER', 'Manage templates');
if (!defined('_ADMIN_TEMPLATES_DESC'))
    define('_ADMIN_TEMPLATES_DESC', 'Manage templates with office and html');

/*********************** Menu ***********************************/
if (!defined('_EXPLOIT_TEMPLATE_ANSWER'))
    define('_EXPLOIT_TEMPLATE_ANSWER', 'Use templates');
if (!defined('_TEMPLATE_NAME'))
    define('_TEMPLATE_NAME', 'Template name');
if (!defined('_TEMPLATES_COMMENT'))
    define('_TEMPLATES_COMMENT', 'Document template');
if (!defined('_TEMPLATE_EMPTY'))
    define('_TEMPLATE_EMPTY', 'The template is empty');
if (!defined('_ATTACH_TEMPLATE_TO_ENTITY'))
    define('_ATTACH_TEMPLATE_TO_ENTITY', 'The template must be attached to at least one department');
if (!defined('_TEMPLATE_LABEL'))
    define( '_TEMPLATE_LABEL', 'Template name');
if (!defined('_TEMPLATE_COMMENT'))
    define( '_TEMPLATE_COMMENT', 'Desciption');
if (!defined('_TEMPLATE_TYPE'))
    define( '_TEMPLATE_TYPE', 'Template type');
if (!defined('_TEMPLATE_STYLE'))
    define( '_TEMPLATE_STYLE', 'Template association');
if (!defined('_EDIT_TEMPLATE'))
    define( '_EDIT_TEMPLATE', 'Edit template');
if (!defined('_TEMPLATE_ID'))
    define( '_TEMPLATE_ID', 'Template ID');
if (!defined('_ATTACH_TEMPLATE_TO_ENTITY'))
    define('_ATTACH_TEMPLATE_TO_ENTITY', 'Please attach template to at least one department');
if (!defined('_TEMPLATE_DATASOURCE'))
    define('_TEMPLATE_DATASOURCE', 'Datasource');
if (!defined('_OFFICE'))
    define('_OFFICE', 'Office');
if (!defined('_HTML'))
    define('_HTML', 'HTML');
if (!defined('_MANAGE_TEMPLATES'))
    define('_MANAGE_TEMPLATES', 'Manage document templates');
if (!defined('_MANAGE_TEMPLATES_APP'))
    define('_MANAGE_TEMPLATES_APP', 'Manage document templates used in this application');

/************** Models : Liste + Formulaire**************/
if (!defined('_TEMPLATES_LIST'))
    define('_TEMPLATES_LIST', 'List of templates');
if (!defined('_ALL_TEMPLATES'))
    define('_ALL_TEMPLATES', 'All templates');
...
if (!defined('_TEMPLATE_ADDITION'))
    define('_TEMPLATE_ADDITION', 'Add a template');
if (!defined('_TEMPLATE_MODIFICATION'))
    define('_TEMPLATE_MODIFICATION', 'Modify a template');
if (!defined('_TEMPLATE_DELETION'))
    define('_TEMPLATE_DELETION', 'Delete a template');
if (!defined('_MODIFY_TEMPLATE'))
    define('_MODIFY_TEMPLATE', 'Save changes');
...
if (!defined('_CHOOSE_ENTITY_TEMPLATE'))
    define('_CHOOSE_ENTITY_TEMPLATE', 'Select the department that can use this template');
...
if (!defined('_GENERATED_FILE'))
    define('_GENERATED_FILE', 'The file has been crfeated');
if (!defined('_MUST_CHOOSE_TEMPLATE'))
    define('_MUST_CHOOSE_TEMPLATE', 'You must select a template');
if (!defined('_GENERATE_ANSWER'))
    define('_GENERATE_ANSWER', 'Create an attachment');
if (!defined('_GENERATE'))
    define('_GENERATE', 'Create an attachment');
if (!defined('_PLEASE_SELECT_TEMPLATE'))
    define('_PLEASE_SELECT_TEMPLATE', 'Select a template for the attachment');
if (!defined('_NO_MODE_DEFINED'))
    define('_NO_MODE_DEFINED', 'Error: leave mode');
if (!defined('_TEMPLATE_OR_ANSWER_ERROR'))
    define('_TEMPLATE_OR_ANSWER_ERROR', 'An error occured while loading the template');
if (!defined('_NO_CONTENT'))
    define('_NO_CONTENT', 'The answer is empty');
if (!defined('_FILE_OPEN_ERROR'))
    define('_FILE_OPEN_ERROR', 'An error occured while opening the file');
if (!defined('_ANSWER_OPEN_ERROR'))
    define('_ANSWER_OPEN_ERROR', 'An error occured while opening the answer');
if (!defined('_TEMPLATE_UPDATE'))
    define('_TEMPLATE_UPDATE', 'Template updated');
if (!defined('_ANSWER_UPDATED'))
    define('_ANSWER_UPDATED', 'Attachment updated');
if (!defined('_ANSWER_TITLE'))
    define('_ANSWER_TITLE', 'Name of the attachment');
