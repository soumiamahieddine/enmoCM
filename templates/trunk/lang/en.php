...
if (!defined('_TEMPLATE_NAME')) define('_TEMPLATE_NAME', 'Template name');
...
if (!defined('_TEMPLATES_LIST')) define('_TEMPLATES_LIST', 'List of templates');
if (!defined('_ALL_TEMPLATES')) define('_ALL_TEMPLATES', 'All templates');
if (!defined('_TEMPLATE')) define('_TEMPLATE', 'Template');
if (!defined('_ADD_TEMPLATE')) define('_ADD_TEMPLATE', 'Add a template');

if (!defined('_THE_TEMPLATE')) define('_THE_TEMPLATE', 'The template ');
if (!defined('_TEMPLATE_ADDITION')) define('_TEMPLATE_ADDITION', 'Add a template');
if (!defined('_TEMPLATE_MODIFICATION')) define('_TEMPLATE_MODIFICATION', 'Modify a template');
...
if (!defined('_ADMIN_TEMPLATES')) define('_ADMIN_TEMPLATES','Manage document templates');
if (!defined('_LOADED_FILE')) define('_LOADED_FILE', 'The file has been saved');
if (!defined('_GENERATED_FILE')) define('_GENERATED_FILE', 'The file has been crfeated');
if (!defined('_MUST_CHOOSE_TEMPLATE')) define('_MUST_CHOOSE_TEMPLATE', 'You must select a template');
if (!defined('_GENERATE_ANSWER')) define('_GENERATE_ANSWER', 'Create an attachment');
if (!defined('_GENERATE')) define('_GENERATE', 'Create an attachment');
if (!defined('_PLEASE_SELECT_TEMPLATE')) define('_PLEASE_SELECT_TEMPLATE', 'Select a template for the attachment');
if (!defined('_NO_MODE_DEFINED')) define('_NO_MODE_DEFINED', 'Error: leave mode');
if (!defined('_TEMPLATE_OR_ANSWER_ERROR')) define('_TEMPLATE_OR_ANSWER_ERROR', 'An error occured while loading the template');
