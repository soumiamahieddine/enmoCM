    ...
    */
    public function uptemplate()
    {
        ...
        else
        {
            ...
            {
                $this->query("update ".$_SESSION['tablename']['temp_templates']." set label = '".$_SESSION['m_admin']['template']['LABEL']."' , template_comment = '".$_SESSION['m_admin']['template']['COMMENT']."', content = '".$_SESSION['m_admin']['template']['CONTENT']."' where id = '".$_SESSION['m_admin']['template']['ID']."'", false, true);
