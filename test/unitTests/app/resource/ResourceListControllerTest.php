...
class ResourceListControllerTest extends TestCase
{
    public function testGet()
    {
        ...
        $response     = $resListController->get($fullRequest, new \Slim\Http\Response(), ['userId' => 19, 'groupId' => 2, 'basketId' => 15]);
        ...
        //  ERRORS
        $response     = $resListController->get($request, new \Slim\Http\Response(), ['userId' => 19, 'groupId' => 777, 'basketId' => 15]);
        $responseBody = json_decode((string)$response->getBody());
        ...
        $response     = $resListController->get($request, new \Slim\Http\Response(), ['userId' => 777, 'groupId' => 2, 'basketId' => 15]);
        $responseBody = json_decode((string)$response->getBody());
    ...
    public function testGetFilters()
    {
        ...
        $response     = $resListController->getFilters($fullRequest, new \Slim\Http\Response(), ['userId' => 19, 'groupId' => 2, 'basketId' => 15]);
        $responseBody = json_decode((string)$response->getBody());
