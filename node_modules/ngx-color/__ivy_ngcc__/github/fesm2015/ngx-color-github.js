...
GithubSwatchComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: GithubSwatchComponent, selectors: [["color-github-swatch"]], inputs: { color: "color" }, outputs: { onClick: "onClick", onSwatchHover: "onSwatchHover" }, decls: 3, vars: 2, consts: [[1, "github-swatch"], [1, "swatch", 3, "color", "focusStyle", "onClick", "onHover"], [1, "clear"]], template: function GithubSwatchComponent_Template(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(GithubSwatchComponent, [{
        type: Component,
        args: [{
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(GithubComponent, [{
        type: Component,
        args: [{
...
ColorGithubModule.ɵfac = function ColorGithubModule_Factory(t) { return new (t || ColorGithubModule)(); };
ColorGithubModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: ColorGithubModule });
ColorGithubModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule, SwatchModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ColorGithubModule, { declarations: function () { return [GithubComponent, GithubSwatchComponent]; }, imports: function () { return [CommonModule, SwatchModule]; }, exports: function () { return [GithubComponent, GithubSwatchComponent]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ColorGithubModule, [{
        type: NgModule,
        args: [{
