...
DragDropService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: DragDropService, factory: function (t) { return DragDropService.ɵfac(t); } });
...
DragDropSortableService.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: DragDropSortableService, factory: function (t) { return DragDropSortableService.ɵfac(t); } });
...
AbstractComponent.ɵprov = ɵngcc0.ɵɵdefineInjectable({ token: AbstractComponent, factory: function (t) { return AbstractComponent.ɵfac(t); } });
...
DraggableHandleComponent.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: DraggableHandleComponent, selectors: [["", "dnd-draggable-handle", ""]], features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
...
SortableContainer.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: SortableContainer, selectors: [["", "dnd-sortable-container", ""]], inputs: { draggable: ["dragEnabled", "draggable"], sortableData: "sortableData", dropzones: ["dropZones", "dropzones"] }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
__decorate$5([
    Input("dragEnabled"),
...
SortableComponent.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: SortableComponent, selectors: [["", "dnd-sortable", ""]], inputs: { draggable: ["dragEnabled", "draggable"], droppable: ["dropEnabled", "droppable"], effectallowed: ["effectAllowed", "effectallowed"], effectcursor: ["effectCursor", "effectcursor"], index: ["sortableIndex", "index"], dragData: "dragData" }, outputs: { onDragSuccessCallback: "onDragSuccess", onDragStartCallback: "onDragStart", onDragOverCallback: "onDragOver", onDragEndCallback: "onDragEnd", onDropSuccessCallback: "onDropSuccess" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
__decorate$5([
    Input('sortableIndex'),
...
SortableHandleComponent.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: SortableHandleComponent, selectors: [["", "dnd-sortable-handle", ""]], features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
