...
define('_PROCESS_DESC', 'Opent de verwerkingspagina van een brief (de metagegevens kunnen niet vanop deze pagina gewijzigd worden).');
define('_INDEX_FILE', 'Een bestand indexeren');
define('_INDEX_FILE_DESC', 'Opent de indexeringspagina om een brief op te slaan.');
define('_VALIDATE_QUALIF', 'Bevestigen/Kwalificeren');
define('_VALIDATE_QUALIF_DESC', 'Opent de wijzigingspagina van een reeds bewaard brief (de metagegevens kunnen vanop deze pagina gewijzigd worden).');
define('_VIEW_DOC', 'Het brief bekijken');
define('_VIEW_DOC_DESC', 'Opent een modaliteit met de weergave van het brief. Verhoogt eveneens het geviewde gegeven van de instancelijst tabel (nuttig indien gebruikt in de bakjes clause)');
