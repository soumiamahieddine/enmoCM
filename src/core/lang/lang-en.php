...
define('_PROCESS_DESC', 'Opens the page for processing a mail (metadata can not be modfied from this page).');
define('_INDEX_FILE', 'Index a file');
define('_INDEX_FILE_DESC', 'Opens the index page to create a mail.');
define('_VALIDATE_QUALIF', 'Validation / certification');
define('_VALIDATE_QUALIF_DESC', 'Opens the edit page of a previously saved mail (metadata can be edited from this page).');
define('_VIEW_DOC', 'See the mail');
define('_VIEW_DOC_DESC', 'Opens a modal with the mail in view. Also increments the \'viewed\' data of the listinstance table (useful if used in the bib clauses).');
define('_CLOSE_MAIL', 'Close a mail');
define('_CLOSE_MAIL_DESC', 'Allows you to update the closing date of a mail (\'closing_date\' of the mlb_coll_ext table). ESSENTIAL in order to complete your document workflow.');
...
define('_CLOSE_MAIL_WITH_ATTACHMENT_DESC', 'Allows you to update the closing date of a mail (\'closing_date\' of the table mlb_coll_ext) with MANDATORY presence of attachment (s) / note (s).');
