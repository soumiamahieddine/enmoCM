export const LANG_FR = {
    ...
    "shipping_small_simple"                     : "Petit format (DL) - Simple fenêtre",
    "shipping_small_double"                     : "Petit format (DL) - Double fenêtre",
    "shipping_big_a4"                           : "Grand format A4 (C4)",
    ...
    "noShippingTemplate"                        : "Aucun modèle d'envois disponibles pour ces entités",
