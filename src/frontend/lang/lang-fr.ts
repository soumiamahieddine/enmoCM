export const LANG_FR = {
    ...
    "resultPageUpdated"                 : "Page de résultats modifiée",
    ...
    "objectSample"                      : "Plainte concernant des nuisances sonore nocturne (le 20/12/2018)",
    "prioritySample"                      : "Urgent",    
    "mailTypeSample"                      : "Réclamation",    
    "destInformations"                      : "Attributaire (entité traitante)",    
    "destInformationsSample"                      : "Barbara BAIN (Pôle Jeunesse et Sport)",  
    "creationLimitDate"                      : "Date de création - Date limite",  
    "creationLimitDateSample"                      : "1er mai - <i class=\"fa fa-stopwatch\"></i>&nbsp;<b color=\"warn\">3 jour(s)</b>",  
