...
export class FolderInputComponent implements OnInit {
    ...
    addItem() {
        ...
        this.dialogRef = this.dialog.open(ConfirmComponent, { autoFocus: false, disableClose: true, data: { title: this.lang.confirm, msg: this.lang.folderCreateMsg + '<b>' + newElem[this.key] + '</b>&nbsp;?' } });
