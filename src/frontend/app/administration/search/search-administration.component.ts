...
export class SearchAdministrationComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    this.headerService.setHeader(
      this.translate.instant("lang.searchAdministration")
    );
  ...
  initCustomFields() {
    return new Promise((resolve, reject) => {
      this.http
        ...
        .pipe(
          map((customData: any) => {
            customData.customFields = customData.customFields.map(
              (info: any) => ({
  ...
  getTemplate() {
    ...
    return new Promise((resolve, reject) => {
      this.http
        .get("../rest/search/configuration")
        .pipe(
          tap((templateData: any) => {
            this.selectedTemplateDisplayedSecondaryData =
              templateData.configuration.listDisplay.templateColumns;
            this.selectedProcessTool.defaultTab =
              templateData.configuration.listEvent.defaultTab;

            templateData.configuration.listDisplay.subInfos.forEach(
              (element: any) => {
  ...
  saveTemplate() {
    ...
    this.selectedListEvent = JSON.parse(
      JSON.stringify({
        defaultTab: this.selectedProcessTool.defaultTab,
      })
    );
    this.http
      .put("../rest/configurations/admin_search ", {
        listDisplay: objToSend,
        listEvent: this.selectedListEvent,
