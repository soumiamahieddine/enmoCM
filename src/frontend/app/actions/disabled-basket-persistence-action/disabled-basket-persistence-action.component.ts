...
export class DisabledBasketPersistenceActionComponent implements OnInit {
    ...
    constructor(private translate: TranslateService, public http: HttpClient, private notify: NotificationService, public dialogRef: MatDialogRef<DisabledBasketPersistenceActionComponent>, @Inject(MAT_DIALOG_DATA) public data: any) { }
