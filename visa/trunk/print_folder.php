...
*/
	...
	$frm_str .= '<tr>';
		...
		$frm_str .= '<a href="javascript://" id="previous_doc" onclick="previousDoc(\'index.php?display=true&module=visa&page=update_printFolder\',\''.$coll_id.'\');"><i class="fa fa-chevron-up fa-4x" title="Précédent"></i></a>';
		
		$frm_str .= '</td>';
		
		$frm_str .= '<td style="width:33%";">';	
		$frm_str .= '<a href="javascript://" id="next_doc" onclick="nextDoc(\'index.php?display=true&module=visa&page=update_printFolder\',\''.$coll_id.'\');"><i class="fa fa-chevron-down fa-4x" title="Suivant"></i></a>';
