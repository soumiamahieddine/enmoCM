(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["installer-installer-module"], {
    ...
    function S62(module, __webpack_exports__, __webpack_require__) {
      ...
      var _installer_routing_module__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ./installer-routing.module */
      "QCVa");
      /* harmony import */


      var _installer_service__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ./installer.service */
      "S2qH");
      /* harmony import */
      ...
      InstallerModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_app_common_module__WEBPACK_IMPORTED_MODULE_2__["SharedModule"], _service_translate_internationalization_module__WEBPACK_IMPORTED_MODULE_3__["InternationalizationModule"], _installer_routing_module__WEBPACK_IMPORTED_MODULE_12__["InstallerRoutingModule"]],
        ...
        _createClass(DatabaseComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.stepFormGroup.controls['dbHostCtrl'].valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["tap"])(function () {
              return _this.stepFormGroup.controls['stateStep'].setValue('');
            })).subscribe();
          ...
          value: function checkConnection() {
            ...
            this.http.get('../rest/installer/databaseConnection', {
              ...
              _this3.dbExist = data.status === 200;

              _this3.notify.success(_this3.translate.instant('lang.rightInformations'));

              _this3.stepFormGroup.controls['stateStep'].setValue('success');

              _this3.nextStep.emit();
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_11__["catchError"])(function (err) {
              _this3.dbExist = false;

              if (err.error.errors === 'Given database has tables') {
                _this3.notify.error(_this3.translate.instant('lang.dbNotEmpty'));
              } else {
                _this3.notify.error(_this3.translate.instant('lang.badInformations'));
              }

              _this3.stepFormGroup.markAllAsTouched();

              _this3.stepFormGroup.controls['stateStep'].setValue('');
      ...
      var DocserversComponent = /*#__PURE__*/function () {
        function DocserversComponent(translate, _formBuilder, notify, http, installerService) {
          ...
          this.stepFormGroup.controls['docserversPath'].valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["tap"])(function () {
            return _this4.stepFormGroup.controls['stateStep'].setValue('');
          })).subscribe();
        }
        ...
        _createClass(DocserversComponent, [{
          ...
          value: function checkAvailability() {
            ...
            this.http.get('../rest/installer/docservers', {
              ...
              _this5.notify.error(_this5.translate.instant('lang.pathUnreacheable'));
      ...
      var WelcomeComponent = /*#__PURE__*/function () {
        ...
        _createClass(WelcomeComponent, [{
          ...
          value: function getLang() {
            ...
            this.http.get('../rest/languages').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["tap"])(function (data) {
              _this6.langs = Object.keys(data.langs).filter(function (lang) {
                return lang !== 'nl';
              });
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["catchError"])(function (err) {
              _this6.notify.handleSoftErrors(err);
          ...
          value: function getCustoms() {
            ...
            this.http.get('../rest/installer/customs').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["tap"])(function (data) {
              _this7.customs = data.customs;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_9__["catchError"])(function (err) {
              _this7.notify.handleSoftErrors(err);
    ...
    function CImi(module, __webpack_exports__, __webpack_require__) {
      ...
      var CustomizationComponent = /*#__PURE__*/function () {
        function CustomizationComponent(translate, _formBuilder, notify, sanitizer, scanPipe, http, installerService) {
          ...
          this.backgroundList = [];
          var valIdentifier = [_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern(/^[a-z0-9_\-]*$/), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].minLength(3)];
          this.stepFormGroup = this._formBuilder.group({
        ...
        _createClass(CustomizationComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.stepFormGroup.controls['customId'].valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["tap"])(function () {
              _this8.stepFormGroup.controls['firstCtrl'].setValue('');
              ...
              return _this8.stepFormGroup.controls['customId'].errors === null || _this8.stepFormGroup.controls['customId'].errors.pattern === undefined;
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["tap"])(function () {
              _this8.checkCustomExist();
            })).subscribe();
          }
        }, {
          key: "initStep",
          ...
          value: function checkCustomExist() {
            ...
            this.http.get('../rest/installer/custom', {
              ...
              if (_this9.stepFormGroup.controls['customId'].errors !== null) {
                var error = _this9.stepFormGroup.controls['customId'].errors;
                delete error.customExist;
              } else {
                _this9.stepFormGroup.controls['firstCtrl'].setValue('success');
              }
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["catchError"])(function (err) {
              ...
              if (err.error.errors.match(regex) !== null) {
                _this9.stepFormGroup.controls['customId'].setErrors(Object.assign(Object.assign({}, _this9.stepFormGroup.controls['customId'].errors), {
                  customExist: true
                }));

                _this9.stepFormGroup.controls['customId'].markAsTouched();
            ...
            if (fileInput.target.files && fileInput.target.files[0]) {
              ...
              if (res === true) {
                ...
                reader.onload = function (value) {
                  if (mode === 'logo') {
                    _this10.stepFormGroup.controls['uploadedLogo'].setValue(value.target.result);
                  } else {
                    var img = new Image();

                    img.onload = function (imgDim) {
                      if (imgDim.target.width < 1920 || imgDim.target.height < 1080) {
                        _this10.notify.error(_this10.translate.instant('lang.badImageResolution', {
                          value1: '1920x1080'
                        }));
                      } else {
                        _this10.backgroundList.push({
                          filename: value.target.result,
                          url: value.target.result
                        });

                        _this10.stepFormGroup.controls['bodyLoginBackground'].setValue(value.target.result);
                      }
                    };
      ...
      var InstallActionComponent = /*#__PURE__*/function () {
        ...
        _createClass(InstallActionComponent, [{
          ...
          value: function ngAfterViewInit() {
            ...
            setTimeout(function () {
              return _this11.disableAnimation = false;
            });
          }
        }, {
          key: "launchInstall",
          ...
          value: function initSteps() {
            ...
            this.data.forEach(function (step, index) {
              if (index === 0) {
                _this12.customId = step.body.customId;
              } else {
                step.body.customId = _this12.customId;
              }
          ...
          value: function doStep(index) {
            ...
            return new Promise(function (resolve, reject) {
              if (_this13.installerService.isStepAlreadyLaunched(_this13.data[index].idStep)) {
                _this13.steps[index].state = 'OK';
                resolve(true);
              } else {
                _this13.http[_this13.data[index].route.method.toLowerCase()](_this13.data[index].route.url, _this13.data[index].body).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["tap"])(function (data) {
                  _this13.steps[index].state = 'OK';

                  _this13.installerService.setStep(_this13.steps[index]);

                  resolve(true);
                }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["catchError"])(function (err) {
                  _this13.steps[index].state = 'KO';

                  if (err.error.lang !== undefined) {
                    _this13.steps[index].msgErr = _this13.translate.instant('lang.' + err.error.lang);
                  } else {
                    _this13.steps[index].msgErr = err.error.errors;
                  }
          ...
          value: function goToInstance() {
            ...
            this.http.request('DELETE', '../rest/installer/lock', {
              ...
              _this14.authService.noInstall = false;
              window.location.href = res.url;

              _this14.dialogRef.close('ok');
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["catchError"])(function (err) {
              _this14.notify.handleSoftErrors(err);
        ...
        _createClass(InstallerComponent, [{
          ...
          value: function endInstall() {
            ...
            dialogRef.afterClosed().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_15__["filter"])(function (result) {
              return !_this15.functionService.empty(result);
              ...
              _this15.notify.handleErrors(err);
        ...
        _createClass(UseradminComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.stepFormGroup.controls['password'].valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])(function (data) {
              if (data !== _this16.stepFormGroup.controls['passwordConfirm'].value) {
                _this16.stepFormGroup.controls['password'].setErrors({
                  'incorrect': true
                });

                _this16.stepFormGroup.controls['passwordConfirm'].setErrors({
                  'incorrect': true
                });

                _this16.stepFormGroup.controls['passwordConfirm'].markAsTouched();
              } else {
                _this16.stepFormGroup.controls['password'].setErrors(null);

                _this16.stepFormGroup.controls['passwordConfirm'].setErrors(null);
              }
            })).subscribe();
            this.stepFormGroup.controls['passwordConfirm'].valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_8__["tap"])(function (data) {
              if (data !== _this16.stepFormGroup.controls['password'].value) {
                _this16.stepFormGroup.controls['password'].setErrors({
                  'incorrect': true
                });

                _this16.stepFormGroup.controls['password'].markAsTouched();
        ...
        _createClass(PrerequisiteComponent, [{
          ...
          value: function getStepData() {
            ...
            this.http.get('../rest/installer/prerequisites').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["tap"])(function (data) {
              _this17.prerequisites = data.prerequisites;
              Object.keys(_this17.packagesList).forEach(function (group) {
                _this17.packagesList[group].forEach(function (item, key) {
                  _this17.packagesList[group][key].state = _this17.prerequisites[_this17.packagesList[group][key].label] ? 'ok' : 'ko';

                  if (_this17.packagesList[group][key].label === 'phpVersionValid') {
                    _this17.translate.setTranslation(_this17.translate.getDefaultLang(), {
                      lang: {
                        install_phpVersionValid_desc: _this17.translate.instant('lang.currentVersion') + ' : ' + _this17.prerequisites['phpVersion']
                      }
                    }, true);
                  }
                });
              ...
              _this17.stepFormGroup.controls['firstCtrl'].setValue(_this17.checkStep());

              _this17.stepFormGroup.controls['firstCtrl'].markAsUntouched();
            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_10__["catchError"])(function (err) {
              _this17.notify.handleSoftErrors(err);
          ...
          value: function initStep() {
            ...
            Object.keys(this.packagesList).forEach(function (group) {
              _this18.packagesList[group].forEach(function (item, key) {
                if (_this18.packagesList[group][key].state === 'ko') {
                  _this18.packageItem.toArray().filter(function (itemKo) {
                    return itemKo._elementRef.nativeElement.id === _this18.packagesList[group][key].label;
                  })[0].toggle();
                }
          ...
          value: function checkStep() {
            ...
            var state = 'success';
            Object.keys(this.packagesList).forEach(function (group) {
              _this19.packagesList[group].forEach(function (item) {
                if (item.state === 'ko') {
                  state = '';
                }
              });
